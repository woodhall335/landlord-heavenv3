...
export const UNIVERSAL_HERO_LIBRARY = [
  ...
  hero('assistedSection8', 'hero-assisted-section8-v2', 'Section 8 notice preparation with callback, service and validity checks', 'service', ['/assisted-prep/start?service=section8']),
  hero('assistedPossession', 'hero-assisted-possession-v2', 'Possession claim bundle prepared with callback and evidence support', 'service', ['/assisted-prep/start?service=possession']),
  hero('assistedMoneyClaim', 'hero-assisted-money-claim-v2', 'Money-claim evidence and debt file prepared with callback support', 'service', ['/assisted-prep/start?service=money_claim']),
  ...
  hero('tenancyEnglandStandard', 'hero-tenancy-england-standard-v2', 'Straightforward England tenancy agreement with home and keys', 'tenancy', ['/products/ast', '/standard-tenancy-agreement']),
