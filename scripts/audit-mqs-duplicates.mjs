 ...
 */
function extractFactKey(questionId, mapsTo, fieldId) {
 ...
 */
function extractFactKeyMappings(question) {
  const mappings = [];
 ...
 */
function analyzeAndRecommend(occurrences) {
 ...
 */
function findCriticalDuplicates(groups) {
  const critical = [];
