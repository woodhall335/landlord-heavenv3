import { generateScotlandMoneyClaim } from '../src/lib/documents/scotland-money-claim-pack-generator.ts';
import { savePackPreview } from './helpers/save-pack.ts';

const sampleCase = {
  jurisdiction: 'scotland' as const,
  case_id: 'case-sc-money-cli-1',
...
async function main() {
  ...
  await savePackPreview('Scotland Simple Procedure Money Claim Pack', 'scotland-money-claim', pack.documents);
}
