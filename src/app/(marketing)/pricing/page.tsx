      ...
      <FAQSection
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              'Yes. The pricing page includes both the Standard Section 13 rent increase pack and the Defence Pack, with prices pulled from the same central product pricing used across the site.',
          },
        ]}
