            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  ...
                  <li>Default judgment: 2â€“4 weeks.</li>
                  <li>Defended claims: 3â€“6 months.</li>
                </ul>
              </div>
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                ...
                <Link href="/money-claim-unpaid-rent" className="text-primary text-sm font-medium hover:underline inline-flex mt-3">
                  See the landlord money claim guide â†’
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>â€¢ Tenant owes rent arrears (current or former tenant)</li>
              ...
              <div className="bg-amber-50 border-l-4 border-amber-500 p-6 rounded-r-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>â€¢ Tenant has no known income or assets</li>
                  <li>â€¢ Tenant has left the country</li>
                  <li>â€¢ You don&apos;t have current contact details</li>
                  <li>â€¢ Arrears are very small (court fees may exceed recovery)</li>
                </ul>
              </div>
            </div>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-6 space-y-2 text-sm text-gray-600">
              ...
              <p>â€¢ Money Claim Online (MCOL) is cheaper - use it where possible</p>
            </div>
          </div>
        </Container>
      </section>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-4">
                    A money claim recovers what you&apos;re owed â€” but if you also need the tenant OUT of the
                  ...
                  <p className="text-sm text-gray-500 mt-3">
                    <Link href="/how-to-evict-tenant" className="text-primary hover:underline">
                      Learn about the eviction process â†’
                    </Link>
                  </p>
                </div>
              </div>
