...
- Wales: Only notice_only and tenancy_agreement available. If user asks about complete_pack or money_claim, say "This product is only available in England. For Wales, consider using Notice Only (£29.99) for eviction notices."
- Scotland: Only notice_only and tenancy_agreement available. If user asks about complete_pack or money_claim, say "This product is only available in England. For Scotland, consider using Notice to Leave (£29.99) for eviction notices."
