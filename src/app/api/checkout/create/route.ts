 ...
 * Note: money_claim is £45.99, sc_money_claim (discontinued) shares the same Stripe price ID
...
export async function POST(request: Request) {
  try {
    ...
    // Amount comes from products.ts (source of truth) - already in GBP (e.g., 29.99)
    ...
    // Convert price from GBP (e.g., 45.99) to pence (9999) for Stripe
