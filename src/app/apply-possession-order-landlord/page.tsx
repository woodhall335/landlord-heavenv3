...
const canonicalUrl = getCanonicalUrl('/apply-possession-order-landlord');

export const metadata: Metadata = {
  title: 'Apply Possession Order Landlord | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Apply Possession Order Landlord.',
...
export default function ApplyPossessionOrderLandlordPage() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=notice_only&src=seo_apply_possession_order_landlord&topic=eviction',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Apply Possession Order Landlord'}
