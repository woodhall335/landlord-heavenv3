    ...
    <>
      ...
      <main>
        ...
        <UniversalHero
          ...
          primaryCta={{
            label: `Create Eviction Notice â€” ${PRODUCTS.notice_only.displayPrice}`,
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-primary/5 rounded-2xl p-6 border-2 border-primary relative">
                  ...
                  <div className="mt-6 pt-4 border-t border-primary/20">
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      <li>â€¢ Form N5B (claim form)</li>
                      <li>â€¢ Form N215 (certificate of service)</li>
                      <li>â€¢ Copy of Section 21 notice</li>
                      <li>â€¢ Copy of tenancy agreement</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    <h4 className="font-semibold text-gray-900 mb-2">Forms needed:</h4>
                    <ul className="text-sm text-gray-600 space-y-1">
                      <li>â€¢ Form N5 (claim form)</li>
                      <li>â€¢ Form N119 (particulars of claim)</li>
                      <li>â€¢ Copy of eviction notice</li>
                      <li>â€¢ Copy of tenancy agreement</li>
                    </ul>
                  </div>
                </div>
