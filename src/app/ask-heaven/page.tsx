...
const canonicalUrl = getCanonicalUrl('/ask-heaven');

export const metadata: Metadata = {
  title: 'Ask Heaven | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Ask Heaven.',
...
export default function AskHeavenPage() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=ast_standard&src=seo_ask_heaven&topic=tenancy',
  };
