...
export const metadata: Metadata = {
  title: 'Assured Shorthold Tenancy Agreement Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Assured Shorthold Tenancy Agreement Template.',
...
export default function AssuredShortholdTenancyAgreementTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_assured_shorthold_tenancy_agreement_template&topic=tenancy',
  };
