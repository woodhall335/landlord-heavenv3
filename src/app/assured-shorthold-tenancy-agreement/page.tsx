...
export const metadata: Metadata = {
  title: 'Assured Shorthold Tenancy Agreement | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Assured Shorthold Tenancy Agreement.',
...
export default function AssuredShortholdTenancyAgreementPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_assured_shorthold_tenancy_agreement&topic=tenancy',
  };
