...
const wizardHref =
  '/wizard?product=ast_standard&jurisdiction=england&src=seo_assured_shorthold_tenancy_agreement&topic=tenancy';
const premiumWizardHref =
  '/wizard?product=ast_premium&jurisdiction=england&src=seo_assured_shorthold_tenancy_agreement&topic=tenancy';
