...
export const metadata: Metadata = {
  title: 'Ast Template England | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Ast Template England.',
...
export default function AstTemplateEnglandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_ast_template_england&topic=tenancy',
  };
