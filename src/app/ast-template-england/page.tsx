...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes. Our template supports multiple tenants on a single AST, creating a joint tenancy. All named tenants become jointly and severally liable â€” meaning each tenant is responsible for the full rent, not just their share. This protects landlords if one tenant fails to pay. The wizard collects details for all tenants and generates signature blocks for each.',
  },
  {
      ...
      <main className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-4 text-sm text-gray-500">10-minute wizard â€¢ Instant download â€¢ Legally valid</p>
          </div>
        </section>
