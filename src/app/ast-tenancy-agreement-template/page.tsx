...
export const metadata: Metadata = {
  title: 'Ast Tenancy Agreement Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Ast Tenancy Agreement Template.',
...
export default function AstTenancyAgreementTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_ast_tenancy_agreement_template&topic=tenancy',
  };
