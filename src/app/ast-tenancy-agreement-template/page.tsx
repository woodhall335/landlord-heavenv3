...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'AST Tenancy Agreement Template 2026 | England Agreement Updated',
    description:
      "Use the updated 2026 England tenancy agreement flow for AST tenancy agreement template searches.",
  },
};

const faqs = [
  {
    question: 'Is this still an AST tenancy agreement template?',
    answer:
      'This page captures AST tenancy agreement template search intent, but the live Landlord Heaven route is now positioned as the updated England Tenancy Agreement 2026 rather than using legacy AST-first product language.',
  },
  {
    question: 'Why keep the AST wording on this page?',
    answer:
      'Because many England landlords still search for AST terminology. This page keeps that search intent while moving users into the newer England agreement flow with more current wording and stronger product positioning.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'It is for landlords in England who still search for AST templates but need a more modern 2026 tenancy agreement route instead of relying on thin legacy AST-only landing pages.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. That is the purpose of this page. It captures AST query demand while moving users into the updated England agreement flow with newer public-facing product language.',
  },
  {
...
export default function AstTenancyAgreementTemplatePage() {
  const pageSchema = {
    ...
    '@type': 'WebPage',
    name: 'AST Tenancy Agreement Template 2026',
    description:
      'Create the updated 2026 England tenancy agreement online for landlords searching for an AST tenancy agreement template.',
    url: canonicalUrl,
  };
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <StructuredData
        data={breadcrumbSchema([
          ...
          { name: 'AST Tenancy Agreement Template 2026', url: canonicalUrl },
        ])}
      />
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center">
              <div className="inline-flex items-center rounded-full bg-red-100 px-4 py-2 text-sm font-semibold text-red-800 mb-5">
                Updated England route for AST tenancy agreement template searches
              </div>

              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                AST Tenancy Agreement Template 2026
              </h1>

              <p className="text-xl text-gray-700 max-w-4xl mx-auto mb-4">
                If you are searching for an <strong>AST tenancy agreement template</strong>, this is
                the updated England route. Landlord Heaven now positions the live product as the{' '}
                <strong>England Tenancy Agreement 2026</strong> with{' '}
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto rounded-2xl border border-gray-100 bg-white p-8 md:p-10 shadow-sm">
              ...
              <p className="text-gray-600 text-center mb-10 max-w-3xl mx-auto">
                ...
                AST templates but now need a more modern tenancy agreement journey.
              </p>
              ...
              <div className="space-y-5 text-gray-700 leading-relaxed">
                ...
                <p>
                  That change matters because the search market and the commercial product journey are
                  not always identical. Many landlords still search for{' '}
                  <strong>AST tenancy agreement template</strong>,{' '}
                  <strong>assured shorthold tenancy template</strong>, or similar phrases, even when
                  the stronger landing-page experience is no longer a thin AST-only route.
                </p>
                ...
                <p>
                  In other words, the page now works as a real standalone landing page, not just a
                  legacy placeholder. It captures the old query but sells the updated England route.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
                AST still matters for search demand, but it is no longer the strongest way to frame
                the whole public product journey.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-700">
                    Landlords continue to search for AST terminology, so removing these pages entirely
                    would leave real commercial traffic behind.
                  </p>
                </div>
              ...
              <div className="mt-10 max-w-4xl mx-auto space-y-5 text-gray-700 leading-relaxed">
                <p>
                  Older AST-first pages often rank because they match the query, but they do not
                  always convert well because they feel thin, historic or too tied to outdated
                  product language.
                </p>

                <p>
                  Stronger competitor pages usually do more. They answer the legacy query, add
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto rounded-2xl border border-red-200 bg-red-50 p-8 md:p-10">
              ...
              <p className="text-gray-700 text-center mb-10 max-w-3xl mx-auto">
                ...
                wording rather than older AST-only commercial language.
              </p>
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
                A strong England tenancy agreement should do more than fill in names and rent. It
        ...
        <section className="py-16 lg:py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 text-center mb-4">
                Common mistakes with old AST tenancy agreement templates
              </h2>
              <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="rounded-2xl border border-red-200 bg-red-50 p-6">
                  ...
                  <p className="text-gray-700">
                    Old AST template pages often match the query but do little to support the landlord
                    with broader product guidance or stronger drafting context.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-red-200 bg-red-50 p-6">
                  ...
                  <p className="text-gray-700">
                    The query may still be AST, but the commercial route can be stronger when framed as
                    an updated England tenancy agreement.
                  </p>
                </div>
        ...
        {/* England vs old AST terminology */}
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 text-center mb-4">
                ...
                <table className="w-full rounded-xl border border-gray-200 bg-white">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    <tr>
                      ...
                      <td className="px-4 py-3 text-gray-700">AST tenancy agreement template</td>
              ...
              <div className="mt-10 max-w-4xl mx-auto space-y-5 text-gray-700 leading-relaxed">
                <p>
                  This comparison is not about pretending AST demand has disappeared. It is about
                  making sure the page that captures that demand is also commercially stronger and more
                  useful than a basic legacy page.
                </p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="rounded-2xl border-2 border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <ul className="space-y-3 text-gray-700 mb-6">
                    ...
                    <li>✓ AST template search capture with modern product language</li>
        ...
        <FAQSection
          faqs={faqs}
          title="AST Tenancy Agreement Template FAQ"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto rounded-2xl bg-red-600 p-10 md:p-12 text-center text-white shadow-2xl">
              ...
              <p className="text-xl text-red-50 mb-8 max-w-3xl mx-auto">
                Keep AST search visibility, use stronger 2026 wording, and move landlords into a more
                competitive modern England agreement flow.
              </p>
