...
const canonicalUrl = getCanonicalUrl('/claim-rent-arrears-tenant');

export const metadata: Metadata = {
  title: 'Claim Rent Arrears Tenant | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Claim Rent Arrears Tenant.',
...
export default function ClaimRentArrearsTenantPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_claim_rent_arrears_tenant&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Claim Rent Arrears Tenant'}
