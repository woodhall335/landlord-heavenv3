...
const canonicalUrl = getCanonicalUrl('/common-prt-tenancy-mistakes-scotland');

export const metadata: Metadata = {
  title: 'Common Prt Tenancy Mistakes Scotland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Common Prt Tenancy Mistakes Scotland.',
...
export default function CommonPrtTenancyMistakesScotlandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_common_prt_tenancy_mistakes_scotland&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Common Prt Tenancy Mistakes Scotland'}
