...
const canonicalUrl = getCanonicalUrl('/county-court-claim-form-guide');

export const metadata: Metadata = {
  title: 'County Court Claim Form Guide | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for County Court Claim Form Guide.',
...
export default function CountyCourtClaimFormGuidePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_county_court_claim_form_guide&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'County Court Claim Form Guide'}
