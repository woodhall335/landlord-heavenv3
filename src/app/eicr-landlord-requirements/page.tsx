...
const canonicalUrl = getCanonicalUrl('/eicr-landlord-requirements');

export const metadata: Metadata = {
  title: 'Eicr Landlord Requirements | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Eicr Landlord Requirements.',
...
export default function EicrLandlordRequirementsPage() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=ast_standard&src=seo_eicr_landlord_requirements&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Eicr Landlord Requirements'}
