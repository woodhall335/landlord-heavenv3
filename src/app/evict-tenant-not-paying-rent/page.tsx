...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'For new England private-rented cases after 1 May 2026, Section 21 is no longer the live route. Use the current Section 8 / Form 3A process and choose the arrears grounds that match the facts and evidence.',
  },
  {
