...
const canonicalUrl = getCanonicalUrl('/eviction-cost-uk');

export const metadata: Metadata = {
  title: 'Eviction Cost Uk | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Eviction Cost Uk.',
...
export default function EvictionCostUkPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_eviction_cost_uk&topic=eviction',
  };
