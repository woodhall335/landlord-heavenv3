    ...
    <>
      ...
      <main>
        ...
        <StandardHero
          ...
          primaryCTA={{ label: 'Save £1,000+ — DIY Pack from £39.99', href: wizardLinkNoticeOnly }}
                ...
                <table className="w-full">
                  <tbody className="divide-y divide-gray-200">
                    <tr className="bg-green-50">
                      ...
                      <td className="px-6 py-4 text-right font-medium text-green-700">£39.99</td>
                    </tr>
                    <tr className="bg-green-50">
                      <td className="px-6 py-4 text-gray-700">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <SeoCtaBlock
                ...
                description="Court-ready documents from £39.99. Save over £1,000 compared to solicitor fees."
              />
