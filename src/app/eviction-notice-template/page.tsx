...
export const metadata: Metadata = {
  title: 'Eviction Notice Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Eviction Notice Template.',
...
export default function EvictionNoticeTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_eviction_notice_template&topic=eviction',
  };
