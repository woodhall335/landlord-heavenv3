        ...
        <section className="py-12 bg-gradient-to-r from-[#692ED4] via-[#7A3BE5] to-[#5a21be] text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <IntentProductCTA intent={{ product: 'notice_only', src: 'seo_eviction_notice_template', topic: 'eviction' }} label="Generate Court-Ready Notice — £19.99" className="hero-btn-secondary inline-flex items-center gap-2" />
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#F3EEFF] py-16 lg:py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-gradient-to-br from-primary to-primary/90 rounded-3xl p-8 lg:p-12 text-white text-center">
              ...
              <IntentProductCTA intent={{ product: 'notice_only', src: 'seo_eviction_notice_template', topic: 'eviction' }} label="Generate Court-Ready Notice — £19.99" className="hero-btn-secondary inline-flex items-center justify-center gap-2" />
