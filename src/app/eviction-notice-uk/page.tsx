...
const canonicalUrl = getCanonicalUrl('/eviction-notice-uk');

export const metadata: Metadata = {
  title: 'Eviction Notice Uk | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Eviction Notice Uk.',
...
export default function EvictionNoticeUkPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_eviction_notice_uk&topic=eviction',
  };
