...
export const metadata: Metadata = {
  title: 'Eviction Notice | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Eviction Notice.',
...
export default function EvictionNoticePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_eviction_notice&topic=eviction',
  };
