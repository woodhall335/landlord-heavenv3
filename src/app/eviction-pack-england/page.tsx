...
export const metadata: Metadata = {
  title: 'Eviction Pack England | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Eviction Pack England.',
...
export default function EvictionPackEnglandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_eviction_pack_england&topic=eviction',
  };
