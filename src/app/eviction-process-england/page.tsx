...
const canonicalUrl = getCanonicalUrl('/eviction-process-england');

export const metadata: Metadata = {
  title: 'Eviction Process England | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Eviction Process England.',
...
export default function EvictionProcessEnglandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_eviction_process_england&topic=eviction',
  };
