...
export const metadata: Metadata = {
  ...
  description:
    'Guide to the eviction process in England. Legal steps, timelines, and costs for Section 21 and Section 8 evictions. From £19.99.',
  keywords: [
  ...
  openGraph: {
    title: 'Eviction Process England | How to Evict a Tenant | Landlord Heaven',
    description:
      'Complete guide to the eviction process in England. Learn the legal steps, timelines, and costs. Get court-ready eviction documents from £19.99.',
    type: 'article',
