...
const canonicalUrl = getCanonicalUrl('/eviction-process-scotland');

export const metadata: Metadata = {
  title: 'Eviction Process Scotland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Eviction Process Scotland.',
...
export default function EvictionProcessScotlandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_eviction_process_scotland&topic=eviction',
  };
