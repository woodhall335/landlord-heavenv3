...
const canonicalUrl = getCanonicalUrl('/eviction-process-wales');

export const metadata: Metadata = {
  title: 'Eviction Process Wales | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Eviction Process Wales.',
...
export default function EvictionProcessWalesPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_eviction_process_wales&topic=eviction',
  };
