...
const canonicalUrl = getCanonicalUrl('/fixed-term-periodic-occupation-contract-wales');

export const metadata: Metadata = {
  title: 'Fixed Term Periodic Occupation Contract Wales | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Fixed Term Periodic Occupation Contract Wales.',
...
export default function FixedTermPeriodicOccupationContractWalesPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_fixed_term_periodic_occupation_contract_wales&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Fixed Term Periodic Occupation Contract Wales'}
