...
export const metadata: Metadata = {
  title: 'Fixed Term Periodic Tenancy England | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Fixed Term Periodic Tenancy England.',
...
export default function FixedTermPeriodicTenancyEnglandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_fixed_term_periodic_tenancy_england&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Fixed Term Periodic Tenancy England'}
