...
const canonicalUrl = getCanonicalUrl('/fixed-term-tenancy-agreement-northern-ireland');

export const metadata: Metadata = {
  title: 'Fixed Term Tenancy Agreement Northern Ireland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Fixed Term Tenancy Agreement Northern Ireland.',
...
export default function FixedTermTenancyAgreementNorthernIrelandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_fixed_term_tenancy_agreement_northern_ireland&topic=tenancy',
  };
