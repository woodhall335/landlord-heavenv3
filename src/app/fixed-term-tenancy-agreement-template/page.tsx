...
export const metadata: Metadata = {
  title: 'Fixed Term Tenancy Agreement Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Fixed Term Tenancy Agreement Template.',
...
export default function FixedTermTenancyAgreementTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_fixed_term_tenancy_agreement_template&topic=tenancy',
  };
