...
const canonicalUrl = getCanonicalUrl('/form-3-section-8');

export const metadata: Metadata = {
  title: 'Form 3 Section 8 | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Form 3 Section 8.',
...
export default function Form3Section8Page() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_form_3_section_8&topic=eviction',
  };
