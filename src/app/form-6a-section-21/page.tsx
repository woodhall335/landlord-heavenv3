...
const canonicalUrl = getCanonicalUrl('/form-6a-section-21');

export const metadata: Metadata = {
  title: 'Form 6A Section 21 | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Form 6A Section 21.',
...
export default function Form6ASection21Page() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=notice_only&src=seo_form_6a_section_21&topic=eviction',
  };
