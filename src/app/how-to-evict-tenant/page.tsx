...
export const metadata: Metadata = {
  title: 'How To Evict Tenant | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for How To Evict Tenant.',
...
export default function HowToEvictTenantPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_how_to_evict_tenant&topic=tenancy',
  };
