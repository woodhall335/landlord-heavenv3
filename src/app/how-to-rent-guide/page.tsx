...
const canonicalUrl = getCanonicalUrl('/how-to-rent-guide');

export const metadata: Metadata = {
  title: 'How To Rent Guide | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for How To Rent Guide.',
...
export default function HowToRentGuidePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_how_to_rent_guide&topic=tenancy',
  };
