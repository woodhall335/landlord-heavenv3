...
const canonicalUrl = getCanonicalUrl('/how-to-sue-tenant-for-unpaid-rent');

export const metadata: Metadata = {
  title: 'How To Sue Tenant For Unpaid Rent | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for How To Sue Tenant For Unpaid Rent.',
...
export default function HowToSueTenantForUnpaidRentPage() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=money_claim&src=seo_how_to_sue_tenant_for_unpaid_rent&topic=debt',
  };
