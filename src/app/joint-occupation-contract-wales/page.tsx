    ...
    <>
      ...
      <main>
        ...
        <UniversalHero
          ...
          primaryCta={{
            label: `Create Joint Contract â€” ${PRODUCTS.ast_standard.displayPrice}`,
              ...
              <div className="prose prose-lg max-w-none text-gray-600">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    contract-holder wants to leave â€” the Renting Homes Act provides specific
                    procedures.
                  </li>
                </ul>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-8 bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
                <p className="text-blue-900 text-sm">
                  ...
                  all joint holders â€” a key difference from England. The remaining holders
