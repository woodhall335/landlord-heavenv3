...
const canonicalUrl = getCanonicalUrl('/joint-occupation-contract-wales');

export const metadata: Metadata = {
  title: 'Joint Occupation Contract Wales | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Joint Occupation Contract Wales.',
...
export default function JointOccupationContractWalesPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_joint_occupation_contract_wales&topic=tenancy',
  };
