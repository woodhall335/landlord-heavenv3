    ...
    <>
      ...
      <main>
        ...
        <UniversalHero
          ...
          primaryCta={{
            label: `Create Joint PRT â€” ${PRODUCTS.ast_standard.displayPrice}`,
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>
                  ...
                  full rent â€” not just their individual share.
                </p>
                <p>
                ...
                <p>
                  ...
                  end the PRT for the remaining tenants â€” the tenancy continues with those who
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        ...
                        who do not sign are not tenants and have no rights under the tenancy â€” but
                        also no obligations.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        ...
                        requirements in your local area â€” penalties for unlicensed HMOs are
                        significant.
                      </p>
                    </div>
                  </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200">
                <p className="text-gray-600 mb-6">
                  Disputes between joint tenants are their matter to resolve â€” you are not required
