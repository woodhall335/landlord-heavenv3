...
const canonicalUrl = getCanonicalUrl('/joint-prt-tenancy-agreement-scotland');

export const metadata: Metadata = {
  title: 'Joint Prt Tenancy Agreement Scotland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Joint Prt Tenancy Agreement Scotland.',
...
export default function JointPrtTenancyAgreementScotlandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_joint_prt_tenancy_agreement_scotland&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Joint Prt Tenancy Agreement Scotland'}
