...
export const metadata: Metadata = {
  ...
  description: 'Guide, templates, and practical next steps for Joint Tenancy Agreement England.',
...
export default function JointTenancyAgreementEnglandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_joint_tenancy_agreement_england&topic=tenancy',
  };
