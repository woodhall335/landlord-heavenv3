...
const canonicalUrl = getCanonicalUrl('/joint-tenancy-agreement-northern-ireland');

export const metadata: Metadata = {
  title: 'Joint Tenancy Agreement Northern Ireland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Joint Tenancy Agreement Northern Ireland.',
...
export default function JointTenancyAgreementNorthernIrelandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_joint_tenancy_agreement_northern_ireland&topic=tenancy',
  };
