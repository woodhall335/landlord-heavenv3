...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Joint and several liability means each tenant is individually responsible for the FULL rent amount, not just their share. If one tenant leaves or stops paying, the remaining tenants must cover the entire rent between them. This clause is essential for landlord protection â€” without it, you could only pursue each tenant for their calculated share, making rent recovery much harder when one tenant defaults.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes, significantly. With a joint tenancy, all tenants share responsibility for the whole property. With individual room agreements (common in HMOs), each tenant has their own contract for their room and shared areas â€” they are only responsible for their own rent. Individual agreements give landlords more control but require more administration and proper HMO licensing.',
  },
  {
    question: 'Can I add or remove a tenant during the tenancy?',
    answer: 'Removing a tenant requires agreement from ALL parties (landlord and all tenants) and should be documented via a deed of surrender/assignment or a new tenancy agreement. Adding a tenant similarly requires a new or amended agreement. You cannot simply cross out or add names â€” the original agreement terms apply to original signatories.',
  },
  {
    question: 'How do I evict one tenant from a joint tenancy?',
    answer: 'You cannot evict just one joint tenant â€” eviction notices apply to the entire tenancy. If one tenant is causing problems, your options are: (1) Wait for the tenancy to become periodic and accept notice from one of the other tenants to end the whole tenancy, then offer a new tenancy to the remaining tenants; (2) Serve notice on the whole tenancy and start fresh. The problematic tenant remains liable for their period of the tenancy.',
  },
  {
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              <p>
                When renting to multiple tenants â€” whether couples, friends, or professional house-sharers â€” the
