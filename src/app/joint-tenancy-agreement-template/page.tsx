...
export const metadata: Metadata = {
  title: 'Joint Tenancy Agreement Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Joint Tenancy Agreement Template.',
...
export default function JointTenancyAgreementTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_joint_tenancy_agreement_template&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Joint Tenancy Agreement Template'}
