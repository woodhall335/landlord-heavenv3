...
export const metadata: Metadata = {
  ...
  description: 'Create a joint tenancy agreement for multiple tenants in England. Includes joint and several liability, deposit handling, and rent responsibility clauses. From £9.99.',
  keywords: [
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="text-sm text-indigo-600">Recommended: Premium AST (£14.99)</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/products/notice-only" className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="font-semibold text-gray-900">Eviction Notices — £39.99</h3>
