        ...
        <section className="py-10 bg-white" id="snippet-opportunities">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto prose prose-slate max-w-none">
              ...
              <p>A lodger agreement is a written contract between a resident landlord and someone renting a room in the landlordâ€™s home. It sets rent, notice terms, house rules, and included services. Clear written terms help prevent disputes and show each partyâ€™s rights and obligations.</p>
