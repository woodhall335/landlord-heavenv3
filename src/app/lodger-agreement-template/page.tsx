...
const canonicalUrl = getCanonicalUrl('/lodger-agreement-template');

export const metadata: Metadata = {
  title: 'Lodger Agreement Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Lodger Agreement Template.',
...
export default function LodgerAgreementTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_lodger_agreement_template&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Lodger Agreement Template'}
