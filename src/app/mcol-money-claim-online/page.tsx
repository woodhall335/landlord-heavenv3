...
const canonicalUrl = getCanonicalUrl('/mcol-money-claim-online');

export const metadata: Metadata = {
  title: 'Mcol Money Claim Online | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Mcol Money Claim Online.',
...
export default function McolMoneyClaimOnlinePage() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=money_claim&src=seo_mcol_money_claim_online&topic=debt',
  };
