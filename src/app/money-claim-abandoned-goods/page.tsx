...
const canonicalUrl = getCanonicalUrl('/money-claim-abandoned-goods');

export const metadata: Metadata = {
  title: 'Money Claim Abandoned Goods | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Abandoned Goods.',
...
export default function MoneyClaimAbandonedGoodsPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_abandoned_goods&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Abandoned Goods'}
