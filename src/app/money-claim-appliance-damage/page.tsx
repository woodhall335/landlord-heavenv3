...
const canonicalUrl = getCanonicalUrl('/money-claim-appliance-damage');

export const metadata: Metadata = {
  title: 'Money Claim Appliance Damage | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Appliance Damage.',
...
export default function MoneyClaimApplianceDamagePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_appliance_damage&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Appliance Damage'}
