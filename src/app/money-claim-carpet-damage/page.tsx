...
const canonicalUrl = getCanonicalUrl('/money-claim-carpet-damage');

export const metadata: Metadata = {
  title: 'Money Claim Carpet Damage | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Carpet Damage.',
...
export default function MoneyClaimCarpetDamagePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_carpet_damage&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Carpet Damage'}
