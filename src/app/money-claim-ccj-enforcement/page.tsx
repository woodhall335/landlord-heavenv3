...
const canonicalUrl = getCanonicalUrl('/money-claim-ccj-enforcement');

export const metadata: Metadata = {
  title: 'Money Claim Ccj Enforcement | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Ccj Enforcement.',
...
export default function MoneyClaimCcjEnforcementPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_ccj_enforcement&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Ccj Enforcement'}
