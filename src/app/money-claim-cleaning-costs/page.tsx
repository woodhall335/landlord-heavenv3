...
const canonicalUrl = getCanonicalUrl('/money-claim-cleaning-costs');

export const metadata: Metadata = {
  title: 'Money Claim Cleaning Costs | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Cleaning Costs.',
...
export default function MoneyClaimCleaningCostsPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_cleaning_costs&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Cleaning Costs'}
