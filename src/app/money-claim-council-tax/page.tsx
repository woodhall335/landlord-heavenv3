...
const canonicalUrl = getCanonicalUrl('/money-claim-council-tax');

export const metadata: Metadata = {
  title: 'Money Claim Council Tax | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Council Tax.',
...
export default function MoneyClaimCouncilTaxPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_council_tax&topic=debt',
  };
