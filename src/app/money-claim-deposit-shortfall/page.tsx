...
const canonicalUrl = getCanonicalUrl('/money-claim-deposit-shortfall');

export const metadata: Metadata = {
  title: 'Money Claim Deposit Shortfall | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Deposit Shortfall.',
...
export default function MoneyClaimDepositShortfallPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_deposit_shortfall&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Deposit Shortfall'}
