...
const canonicalUrl = getCanonicalUrl('/money-claim-early-termination');

export const metadata: Metadata = {
  title: 'Money Claim Early Termination | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Early Termination.',
...
export default function MoneyClaimEarlyTerminationPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_early_termination&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Early Termination'}
