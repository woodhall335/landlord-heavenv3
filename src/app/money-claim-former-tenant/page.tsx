...
const canonicalUrl = getCanonicalUrl('/money-claim-former-tenant');

export const metadata: Metadata = {
  title: 'Money Claim Former Tenant | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Former Tenant.',
...
export default function MoneyClaimFormerTenantPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_former_tenant&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Former Tenant'}
