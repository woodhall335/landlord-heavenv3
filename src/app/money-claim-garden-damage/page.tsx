...
const canonicalUrl = getCanonicalUrl('/money-claim-garden-damage');

export const metadata: Metadata = {
  title: 'Money Claim Garden Damage | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Garden Damage.',
...
export default function MoneyClaimGardenDamagePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_garden_damage&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Garden Damage'}
