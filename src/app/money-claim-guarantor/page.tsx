...
const canonicalUrl = getCanonicalUrl('/money-claim-guarantor');

export const metadata: Metadata = {
  title: 'Money Claim Guarantor | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Guarantor.',
...
export default function MoneyClaimGuarantorPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_guarantor&topic=debt',
  };
