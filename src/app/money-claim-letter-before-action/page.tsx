...
const canonicalUrl = getCanonicalUrl('/money-claim-letter-before-action');

export const metadata: Metadata = {
  title: 'Money Claim Letter Before Action | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Letter Before Action.',
...
export default function MoneyClaimLetterBeforeActionPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_letter_before_action&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Letter Before Action'}
