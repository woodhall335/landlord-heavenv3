...
const canonicalUrl = getCanonicalUrl('/money-claim-n1-claim-form');

export const metadata: Metadata = {
  title: 'Money Claim N1 Claim Form | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim N1 Claim Form.',
...
export default function MoneyClaimN1ClaimFormPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_n1_claim_form&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim N1 Claim Form'}
