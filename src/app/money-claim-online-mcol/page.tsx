...
const canonicalUrl = getCanonicalUrl('/money-claim-online-mcol');

export const metadata: Metadata = {
  title: 'Money Claim Online Mcol | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Online Mcol.',
...
export default function MoneyClaimOnlineMcolPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_online_mcol&topic=debt',
  };
