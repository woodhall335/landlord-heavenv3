...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes. You can usually claim statutory interest (commonly 8% per year) where appropriate. You‚Äôll need to calculate it accurately for your claim.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'MCOL is online and usually faster. The N1 is a paper/standard claim form route often used when MCOL isn‚Äôt suitable. Both can start a county court money claim.',
  },
  {
...
export default function MoneyClaimOnlineMCOLPage() {
  const hero = {
    ...
    trustText: 'MCOL-ready ‚Ä¢ England & Wales (County Court)',
    title: 'Money Claim Online (MCOL)',
    highlightTitle: 'done properly',
    subtitle:
      'Recover unpaid rent and tenancy debt with a court-ready pack. Clear particulars, interest calculation, and a step-by-step filing guide ‚Äî built for MCOL.',
    primaryCta: {
      label: 'Prepare my MCOL claim pack ‚Üí',
      href: '/products/money-claim?topic=debt&src=seo_money_claim_online_mcol',
    },
    secondaryCta: {
      label: 'View Money Claim Pack ‚Üí',
              ...
              <div className="grid gap-6 md:grid-cols-3">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Your claim reads clearly: who owes what, why, and how it‚Äôs calculated.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      We align letter ‚Üí particulars ‚Üí interest ‚Üí filing steps so your story matches end-to-end.
                    </p>
                  </div>
                </div>
            ...
            <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2 lg:items-start">
              <div>
                ...
                <p className="mt-4 text-lg text-gray-700">
                  MCOL is the government‚Äôs online system for issuing county court money claims in
                  England &amp; Wales ‚Äî used by landlords to recover unpaid rent, damages, and other
                  tenancy debts.
                </p>
              ...
              <div className="rounded-3xl border border-[#E6DBFF] bg-white p-6 shadow-[0_14px_36px_rgba(15,23,42,0.06)] md:p-8">
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  ...
                  >
                    View what‚Äôs included <ArrowRight className="h-4 w-4" />
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="mx-auto max-w-6xl">
              ...
              <div className="overflow-hidden rounded-3xl border border-[#E6DBFF] bg-white shadow-[0_14px_36px_rgba(15,23,42,0.06)]">
                  ...
                  <table className="w-full border-collapse text-left text-sm">
                    ...
                    <tbody>
                      {[
                        ...
                        ['£300.01 ‚Äì £500', '£50'],
                        ['£500.01 ‚Äì £1,000', '£70'],
                        ['£1,000.01 ‚Äì £1,500', '£80'],
                        ['£1,500.01 ‚Äì £3,000', '£115'],
                        ['£3,000.01 ‚Äì £5,000', '£205'],
                        ['£5,000.01 ‚Äì £10,000', '£455'],
                        ['£10,000.01 ‚Äì £100,000', '5% of claim'],
                      ].map(([a, b], i) => (
                ...
                <p className="px-6 py-4 text-xs text-gray-500">
                  Fees shown reflect your on-page table (‚Äúcorrect as of January 2026‚Äù). Additional fees may apply if a case proceeds to hearing or enforcement.
                </p>
              </div>
            </div>
          </Container>
          ...
          <Container>
            <div className="mx-auto max-w-6xl rounded-3xl border border-[#E6DBFF] bg-white p-6 shadow-[0_14px_36px_rgba(15,23,42,0.06)] md:p-10">
              <div className="mb-10 text-center">
                ...
                <p className="mt-3 text-gray-700">
                  Everything you need to move from ‚Äútenant owes money‚Äù to a clean MCOL submission.
                </p>
              </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {[
                  ...
                  },
                  {
                    ...
                    text: 'What to enter, what to keep, what happens next ‚Äî and enforcement options.',
          ...
          <Container>
            <div className="mx-auto max-w-3xl rounded-3xl border border-[#E6DBFF] bg-gradient-to-br from-[#692ED4] via-[#7A3BE5] to-[#5a21be] p-8 text-center text-white shadow-[0_22px_60px_rgba(105,46,212,0.35)] md:p-12">
              ...
              <p className="mb-8 text-xl text-white/90">
                Generate your Letter Before Action, Particulars, and interest output ‚Äî aligned end-to-end.
              </p>
              ...
              >
                <li>‚úì Preview before paying</li>
                <li>‚úì Unlimited regenerations</li>
                <li>‚úì Stored 12+ months</li>
                <li>‚úì One-time payment ‚Äî no subscription</li>
              </ul>
            </div>
          </Container>
        </section>
