...
const canonicalUrl = getCanonicalUrl('/money-claim-pap-financial-statement');

export const metadata: Metadata = {
  title: 'Money Claim Pap Financial Statement | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Pap Financial Statement.',
...
export default function MoneyClaimPapFinancialStatementPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_pap_financial_statement&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Pap Financial Statement'}
