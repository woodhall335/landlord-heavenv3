...
const canonicalUrl = getCanonicalUrl('/money-claim-property-damage');

export const metadata: Metadata = {
  title: 'Money Claim Property Damage | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Property Damage.',
...
export default function MoneyClaimPropertyDamagePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_property_damage&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Property Damage'}
