...
const canonicalUrl = getCanonicalUrl('/money-claim-rent-arrears');

export const metadata: Metadata = {
  title: 'Money Claim Rent Arrears | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Rent Arrears.',
...
export default function MoneyClaimRentArrearsPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_rent_arrears&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Rent Arrears'}
