...
const canonicalUrl = getCanonicalUrl('/money-claim-schedule-of-debt');

export const metadata: Metadata = {
  title: 'Money Claim Schedule Of Debt | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Schedule Of Debt.',
...
export default function MoneyClaimScheduleOfDebtPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_schedule_of_debt&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Schedule Of Debt'}
