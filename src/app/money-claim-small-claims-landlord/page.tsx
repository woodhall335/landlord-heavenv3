...
const canonicalUrl = getCanonicalUrl('/money-claim-small-claims-landlord');

export const metadata: Metadata = {
  title: 'Money Claim Small Claims Landlord | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Small Claims Landlord.',
...
export default function MoneyClaimSmallClaimsLandlordPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_small_claims_landlord&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Small Claims Landlord'}
