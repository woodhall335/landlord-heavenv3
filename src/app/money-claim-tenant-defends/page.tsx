...
const canonicalUrl = getCanonicalUrl('/money-claim-tenant-defends');

export const metadata: Metadata = {
  title: 'Money Claim Tenant Defends | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Tenant Defends.',
...
export default function MoneyClaimTenantDefendsPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_tenant_defends&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Tenant Defends'}
