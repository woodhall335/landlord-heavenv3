...
const canonicalUrl = getCanonicalUrl('/money-claim-unpaid-bills');

export const metadata: Metadata = {
  title: 'Money Claim Unpaid Bills | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Unpaid Bills.',
...
export default function MoneyClaimUnpaidBillsPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_unpaid_bills&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Unpaid Bills'}
