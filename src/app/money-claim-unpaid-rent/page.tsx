...
const canonicalUrl = getCanonicalUrl('/money-claim-unpaid-rent');

export const metadata: Metadata = {
  title: 'Money Claim Unpaid Rent | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Unpaid Rent.',
...
export default function MoneyClaimUnpaidRentPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_unpaid_rent&topic=debt',
  };
