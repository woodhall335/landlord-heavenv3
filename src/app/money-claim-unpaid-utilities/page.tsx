...
const canonicalUrl = getCanonicalUrl('/money-claim-unpaid-utilities');

export const metadata: Metadata = {
  title: 'Money Claim Unpaid Utilities | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Unpaid Utilities.',
...
export default function MoneyClaimUnpaidUtilitiesPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_unpaid_utilities&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Money Claim Unpaid Utilities'}
