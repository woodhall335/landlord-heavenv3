...
const canonicalUrl = getCanonicalUrl('/money-claim-wall-damage');

export const metadata: Metadata = {
  title: 'Money Claim Wall Damage | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim Wall Damage.',
...
export default function MoneyClaimWallDamagePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim_wall_damage&topic=debt',
  };
