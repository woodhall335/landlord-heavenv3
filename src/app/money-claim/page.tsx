...
export const metadata: Metadata = {
  title: 'Money Claim | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Money Claim.',
...
export default function MoneyClaimPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_money_claim&topic=debt',
  };
