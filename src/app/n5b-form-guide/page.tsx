...
const canonicalUrl = getCanonicalUrl('/n5b-form-guide');

export const metadata: Metadata = {
  title: 'N5B Form Guide | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for N5B Form Guide.',
...
export default function N5BFormGuidePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_n5b_form_guide&topic=eviction',
  };
