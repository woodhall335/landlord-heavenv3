...
const canonicalUrl = getCanonicalUrl('/ni-private-tenancy-agreement');

export const metadata: Metadata = {
  title: 'Ni Private Tenancy Agreement | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Ni Private Tenancy Agreement.',
...
export default function NiPrivateTenancyAgreementPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_ni_private_tenancy_agreement&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Ni Private Tenancy Agreement'}
