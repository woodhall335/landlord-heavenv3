    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        <UniversalHero
          ...
          primaryCta={{ label: "Start now", href: "/products/ast?src=seo_ni_private_tenancy_agreement&topic=tenancy&jurisdiction=northern-ireland" }}
        ...
        <section className="bg-gradient-to-br from-slate-800 via-emerald-900 to-slate-900 text-white py-16">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/products/ast?src=seo_ni_private_tenancy_agreement&topic=tenancy&jurisdiction=northern-ireland"
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-red-800">
                    <div>
                      ...
                      <ul className="mt-2 space-y-1 text-sm">
                        <li>â€¢ No written agreement: £500</li>
                        <li>â€¢ Unregistered landlord: £500</li>
                        <li>â€¢ Deposit not protected: £500</li>
                      </ul>
                    </div>
                    <div>
                      <strong>Court Prosecution:</strong>
                      <ul className="mt-2 space-y-1 text-sm">
                        <li>â€¢ Fines up to £2,500</li>
