    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        <UniversalHero
          ...
          primaryCta={{ label: "Start now", href: "/products/ast?src=seo_ni_tenancy_agreement_template_free&topic=tenancy&jurisdiction=northern-ireland" }}
        ...
        <section className="bg-gradient-to-br from-amber-700 via-slate-800 to-slate-900 text-white py-16">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/products/ast?src=seo_ni_tenancy_agreement_template_free&topic=tenancy&jurisdiction=northern-ireland"
