...
const canonicalUrl = getCanonicalUrl('/ni-tenancy-agreement-template-free');

export const metadata: Metadata = {
  title: 'Ni Tenancy Agreement Template Free | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Ni Tenancy Agreement Template Free.',
...
export default function NiTenancyAgreementTemplateFreePage() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=ast_standard&src=seo_ni_tenancy_agreement_template_free&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Ni Tenancy Agreement Template Free'}
