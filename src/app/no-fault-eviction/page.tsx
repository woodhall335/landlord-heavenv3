...
const canonicalUrl = getCanonicalUrl('/no-fault-eviction');

export const metadata: Metadata = {
  title: 'No Fault Eviction | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for No Fault Eviction.',
...
export default function NoFaultEvictionPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_no_fault_eviction&topic=eviction',
  };
