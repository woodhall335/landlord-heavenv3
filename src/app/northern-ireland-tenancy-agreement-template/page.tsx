...
const canonicalUrl = getCanonicalUrl('/northern-ireland-tenancy-agreement-template');

export const metadata: Metadata = {
  title: 'Northern Ireland Tenancy Agreement Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Northern Ireland Tenancy Agreement Template.',
...
export default function NorthernIrelandTenancyAgreementTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_northern_ireland_tenancy_agreement_template&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Northern Ireland Tenancy Agreement Template'}
