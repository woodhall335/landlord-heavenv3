...
const canonicalUrl = getCanonicalUrl('/notice-to-quit-northern-ireland-guide');

export const metadata: Metadata = {
  title: 'Notice To Quit Northern Ireland Guide | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Notice To Quit Northern Ireland Guide.',
...
export default function NoticeToQuitNorthernIrelandGuidePage() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=notice_only&src=seo_notice_to_quit_northern_ireland_guide&topic=eviction',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Notice To Quit Northern Ireland Guide'}
