...
const canonicalUrl = getCanonicalUrl('/occupation-contract-template-wales');

export const metadata: Metadata = {
  title: 'Occupation Contract Template Wales | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Occupation Contract Template Wales.',
...
export default function OccupationContractTemplateWalesPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_occupation_contract_template_wales&topic=tenancy',
  };
