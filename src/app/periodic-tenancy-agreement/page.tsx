...
export const metadata: Metadata = {
  title: 'Periodic Tenancy Agreement | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Periodic Tenancy Agreement.',
...
export default function PeriodicTenancyAgreementPage() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=ast_standard&src=seo_periodic_tenancy_agreement&topic=tenancy',
  };
