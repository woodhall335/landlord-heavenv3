...
const canonicalUrl = getCanonicalUrl('/possession-claim-guide');

export const metadata: Metadata = {
  title: 'Possession Claim Guide | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Possession Claim Guide.',
...
export default function PossessionClaimGuidePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_possession_claim_guide&topic=debt',
  };
