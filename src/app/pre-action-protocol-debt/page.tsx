...
const canonicalUrl = getCanonicalUrl('/pre-action-protocol-debt');

export const metadata: Metadata = {
  title: 'Pre Action Protocol Debt | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Pre Action Protocol Debt.',
...
export default function PreActionProtocolDebtPage() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=money_claim&src=seo_pre_action_protocol_debt&topic=debt',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Pre Action Protocol Debt'}
