...
export const metadata: Metadata = {
  title: 'Premium Tenancy Agreement | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Premium Tenancy Agreement.',
...
export default function PremiumTenancyAgreementPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_premium_tenancy_agreement&topic=tenancy',
  };
