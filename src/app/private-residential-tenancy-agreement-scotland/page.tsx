...
const canonicalUrl = getCanonicalUrl('/private-residential-tenancy-agreement-scotland');

export const metadata: Metadata = {
  title: 'Private Residential Tenancy Agreement Scotland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Private Residential Tenancy Agreement Scotland.',
...
export default function PrivateResidentialTenancyAgreementScotlandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_private_residential_tenancy_agreement_scotland&topic=tenancy',
  };
