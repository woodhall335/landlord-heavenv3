          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">{`Standard PRT — ${standardPrice}`}</h3>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border-2 border-blue-200">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4">{`Premium PRT — ${premiumPrice}`}</h3>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
          ...
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-orange-50 to-blue-50 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/products/notice-only" className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="font-semibold text-gray-900">{`Scotland Notice to Leave — ${noticeOnlyPrice}`}</h3>
              ...
              <Link href={premiumWizardHref} className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="font-semibold text-gray-900">{`Premium PRT — ${premiumPrice}`}</h3>
