...
const canonicalUrl = getCanonicalUrl('/private-residential-tenancy-agreement-template');

export const metadata: Metadata = {
  title: 'Private Residential Tenancy Agreement Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Private Residential Tenancy Agreement Template.',
...
export default function PrivateResidentialTenancyAgreementTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_private_residential_tenancy_agreement_template&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Private Residential Tenancy Agreement Template'}
