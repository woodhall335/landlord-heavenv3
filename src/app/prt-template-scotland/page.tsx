...
const canonicalUrl = getCanonicalUrl('/prt-template-scotland');

export const metadata: Metadata = {
  title: 'Prt Template Scotland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Prt Template Scotland.',
...
export default function PrtTemplateScotlandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_prt_template_scotland&topic=tenancy',
  };
