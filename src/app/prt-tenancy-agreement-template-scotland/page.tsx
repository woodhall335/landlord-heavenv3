...
const canonicalUrl = getCanonicalUrl('/prt-tenancy-agreement-template-scotland');

export const metadata: Metadata = {
  title: 'Prt Tenancy Agreement Template Scotland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Prt Tenancy Agreement Template Scotland.',
...
export default function PrtTenancyAgreementTemplateScotlandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_prt_tenancy_agreement_template_scotland&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Prt Tenancy Agreement Template Scotland'}
