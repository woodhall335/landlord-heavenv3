...
export const metadata: Metadata = {
  title: 'Renew Tenancy Agreement England | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Renew Tenancy Agreement England.',
...
export default function RenewTenancyAgreementEnglandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_renew_tenancy_agreement_england&topic=tenancy',
  };
