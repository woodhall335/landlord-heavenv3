...
const canonicalUrl = getCanonicalUrl('/rent-arrears-letter-template');

export const metadata: Metadata = {
  title: 'Rent Arrears Letter Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Rent Arrears Letter Template.',
...
export default function RentArrearsLetterTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_rent_arrears_letter_template&topic=debt',
  };
