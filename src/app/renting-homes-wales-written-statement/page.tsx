...
const canonicalUrl = getCanonicalUrl('/renting-homes-wales-written-statement');

export const metadata: Metadata = {
  title: 'Renting Homes Wales Written Statement | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Renting Homes Wales Written Statement.',
...
export default function RentingHomesWalesWrittenStatementPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_renting_homes_wales_written_statement&topic=tenancy',
  };
