...
export const metadata: Metadata = {
  title: 'Rolling Tenancy Agreement | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Rolling Tenancy Agreement.',
...
export default function RollingTenancyAgreementPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_rolling_tenancy_agreement&topic=tenancy',
  };
