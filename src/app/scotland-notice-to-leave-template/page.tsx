...
const canonicalUrl = getCanonicalUrl('/scotland-notice-to-leave-template');

export const metadata: Metadata = {
  title: 'Scotland Notice To Leave Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Scotland Notice To Leave Template.',
...
export default function ScotlandNoticeToLeaveTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_scotland_notice_to_leave_template&topic=eviction',
  };
