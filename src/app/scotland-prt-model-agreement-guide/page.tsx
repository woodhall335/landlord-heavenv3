...
const canonicalUrl = getCanonicalUrl('/scotland-prt-model-agreement-guide');

export const metadata: Metadata = {
  title: 'Scotland Prt Model Agreement Guide | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Scotland Prt Model Agreement Guide.',
...
export default function ScotlandPrtModelAgreementGuidePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_scotland_prt_model_agreement_guide&topic=tenancy',
  };
