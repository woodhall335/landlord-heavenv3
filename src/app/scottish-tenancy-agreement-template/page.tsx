...
const canonicalUrl = getCanonicalUrl('/scottish-tenancy-agreement-template');

export const metadata: Metadata = {
  title: 'Scottish Tenancy Agreement Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Scottish Tenancy Agreement Template.',
...
export default function ScottishTenancyAgreementTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_scottish_tenancy_agreement_template&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Scottish Tenancy Agreement Template'}
