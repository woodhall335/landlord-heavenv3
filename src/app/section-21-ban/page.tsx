...
const canonicalUrl = getCanonicalUrl('/section-21-ban');

export const metadata: Metadata = {
  title: 'Section 21 Ban | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Section 21 Ban.',
