...
const canonicalUrl = getCanonicalUrl('/section-21-expired-what-next');

export const metadata: Metadata = {
  title: 'Section 21 Expired What Next | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Section 21 Expired What Next.',
...
export default function Section21ExpiredWhatNextPage() {
  const primaryCta = {
    label: 'Start now with guided wizard →',
    href: '/wizard?product=notice_only&src=seo_section_21_expired_what_next&topic=eviction',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Section 21 Expired What Next'}
