...
export const metadata: Metadata = {
  ...
  description: "Evict using Ground 12 for breach of tenancy. Check the 2-week notice, breach evidence, court discretion, mistakes, and court-ready next steps.",
...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    "answer": "Courts do not pre-approve notices. A validated, solicitor-approved Form 3A can help link the clause and evidence, but the court decides the claim."
  },
  {
