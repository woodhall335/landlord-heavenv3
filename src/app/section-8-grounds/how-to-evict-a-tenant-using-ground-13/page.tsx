...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    "answer": "Courts do not pre-approve notices. A validated, solicitor-approved Form 3A can help organise the deterioration evidence, but the court decides the claim."
  },
  {
