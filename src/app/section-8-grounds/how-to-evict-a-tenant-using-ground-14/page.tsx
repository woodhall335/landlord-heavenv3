...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    "answer": "Courts do not pre-approve notices. A current Form 3A and evidence chronology can help, but the court decides whether possession is reasonable."
  },
  {
...
export default function Page() {
  return (
    <div className="min-h-screen bg-[#fcfaff]">
      ...
      <StructuredData data={articleSchema({ headline: "Section 8 Ground 14: Antisocial Behaviour", description: metadata.description as string, url: canonical, image: checklistImage, datePublished: '2026-05-13', dateModified: '2026-08-21' })} />
      ...
      <header className="bg-gradient-to-br from-[#2a2161] via-[#4c2f91] to-[#16213d] pb-14 pt-28 text-white">
        <Container>
          ...
          <h2 className="mt-4 max-w-4xl text-4xl font-bold leading-tight md:text-5xl">How to Evict a Tenant Using Ground 14 - Antisocial Behaviour</h2>
      ...
      <main>
        ...
        <section className="py-12"><Container size="large"><div className="space-y-8">
        ...
        <FAQSection id="faqs" title={"Ground 14 FAQs"} intro={"Answers to common landlord questions about using Ground 14 in England."} faqs={faqs} variant="white" showContactCTA={false} contentWidth="wide" />
      </main>
    </div>
  );
}
