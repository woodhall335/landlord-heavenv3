...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    "answer": "Courts do not pre-approve notices. A validated, solicitor-approved Form 3A can reduce drafting risk, but the judge decides whether Ground 1A is made out."
  },
  {
