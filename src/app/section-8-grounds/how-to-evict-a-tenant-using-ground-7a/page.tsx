...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    "answer": "Courts do not pre-approve notices. A validated, solicitor-approved Form 3A can help structure the trigger evidence, but the court decides whether Ground 7A is proved."
  },
  {
