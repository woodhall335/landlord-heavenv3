...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    "answer": "Courts do not pre-approve notices. A validated, solicitor-approved Form 3A and arrears schedule help reduce mistakes, but the court decides whether Ground 8 is proved."
  },
  {
