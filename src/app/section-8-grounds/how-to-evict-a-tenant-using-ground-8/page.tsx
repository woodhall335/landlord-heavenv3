    ...
    <div className="min-h-screen bg-[#fcfaff]">
      ...
      <header className="bg-gradient-to-br from-[#2a2161] via-[#4c2f91] to-[#16213d] pb-14 pt-28 text-white">
        <Container>
          ...
          <h2 className="mt-4 max-w-4xl text-4xl font-bold leading-tight md:text-5xl">How to Evict a Tenant Using Ground 8 - Serious Rent Arrears</h2>
      ...
      <main>
        ...
        <FAQSection id="faqs" title={"Ground 8 FAQs"} intro={"Answers to common landlord questions about using Ground 8 in England."} faqs={faqs} variant="white" showContactCTA={false} contentWidth="wide" />
      </main>
    </div>
  );
}
