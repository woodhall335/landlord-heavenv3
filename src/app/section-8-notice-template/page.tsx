...
export const metadata: Metadata = {
  title: 'Section 8 Notice Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Section 8 Notice Template.',
...
export default function Section8NoticeTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_section_8_notice_template&topic=eviction',
  };
