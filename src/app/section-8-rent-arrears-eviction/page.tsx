...
const canonicalUrl = getCanonicalUrl('/section-8-rent-arrears-eviction');

export const metadata: Metadata = {
  title: 'Section 8 Rent Arrears Eviction | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Section 8 Rent Arrears Eviction.',
...
export default function Section8RentArrearsEvictionPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=money_claim&src=seo_section_8_rent_arrears_eviction&topic=debt',
  };
