...
const canonicalUrl = getCanonicalUrl('/section-8-vs-section-21');

export const metadata: Metadata = {
  title: 'Section 8 Vs Section 21 | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Section 8 Vs Section 21.',
...
export default function Section8VsSection21Page() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_section_8_vs_section_21&topic=eviction',
  };
