...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const pillarPages = [
    ...
    { path: '/how-to-evict-a-tenant-using-ground-1', priority: 0.82, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-1a', priority: 0.82, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-2', priority: 0.82, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-7a', priority: 0.82, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-8', priority: 0.84, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-10', priority: 0.82, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-11', priority: 0.82, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-12', priority: 0.82, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-13', priority: 0.82, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-14', priority: 0.84, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-15', priority: 0.82, changeFrequency: 'weekly' as const },
    { path: '/how-to-evict-a-tenant-using-ground-17', priority: 0.82, changeFrequency: 'weekly' as const },
    { path: '/evict-tenant-landlord-moving-back-in', priority: 0.78, changeFrequency: 'weekly' as const },
