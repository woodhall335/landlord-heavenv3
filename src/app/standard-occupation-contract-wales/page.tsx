...
const canonicalUrl = getCanonicalUrl('/standard-occupation-contract-wales');

export const metadata: Metadata = {
  title: 'Standard Occupation Contract Wales | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Standard Occupation Contract Wales.',
...
export default function StandardOccupationContractWalesPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_standard_occupation_contract_wales&topic=tenancy',
  };
