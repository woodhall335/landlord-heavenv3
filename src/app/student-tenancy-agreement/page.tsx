...
const chooserWizardHref = '/wizard?product=tenancy_agreement&jurisdiction=england&src=student_tenancy_page&topic=tenancy';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <EnglandTenancyPage
        ...
        subtitle="Choose the Student agreement when the let is student-focused and you need clearer sharer, guarantor, and end-of-term detail than a generic residential agreement provides."
        ...
        introTitle="Student-focused England tenancy drafting"
        introBody={[
          'This route is designed for landlords letting to students where guarantors, joint occupation, and move-out expectations often need clearer drafting from the start.',
          'It is separate from Premium and separate from the HMO / Shared House route. The goal is to match the agreement to the student letting setup instead of forcing student cases into a generic premium tier.',
        ]}
        highlights={[
          'Student-focused agreement wording',
          'Guarantor and sharer detail',
          'End-of-term return expectations',
          'Guided setup with preview before payment',
        ]}
        compliancePoints={[
          "Designed to reflect the Renters' Rights Act changes from 1 May 2026",
          'Built for England student lets within the current public product model',
          'Student cases no longer need to be bundled into the Premium route',
          'Use separate HMO / Shared House or Lodger products where the occupation setup requires them',
        ]}
        keywordTargets={[
          'student tenancy agreement england',
        ...
        idealFor={[
          'the household is genuinely student-focused and guarantor or sharer detail matters from the start',
          'you want clearer student move-out, replacement, and end-of-term hand-back wording than a generic residential agreement gives you',
          'you want the option to include a guarantor deed alongside the main student tenancy pack',
        ]}
        notFor={[
          'the main issue is HMO or shared-house operational management rather than student occupation',
          'the landlord is resident and the arrangement is really a lodger or resident-landlord room let',
          'the let is an ordinary non-student whole-property tenancy and you only need Standard or Premium residential drafting',
        ]}
        ...
        finalCtaBody="Use the Student route for student-focused lets, guarantor-backed student households, and clearer end-of-term expectations. If you are comparing other England products as well, open the full chooser."
      />
    </div>
  );
}
