...
const canonicalUrl = getCanonicalUrl('/tenancy-agreement-northern-ireland');

export const metadata: Metadata = {
  title: 'Tenancy Agreement Northern Ireland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Tenancy Agreement Northern Ireland.',
...
export default function TenancyAgreementNorthernIrelandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_tenancy_agreement_northern_ireland&topic=tenancy',
  };
