...
export const metadata: Metadata = {
  title: 'Tenancy Agreement Template Free | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Tenancy Agreement Template Free.',
...
export default function TenancyAgreementTemplateFreePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_tenancy_agreement_template_free&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Tenancy Agreement Template Free'}
