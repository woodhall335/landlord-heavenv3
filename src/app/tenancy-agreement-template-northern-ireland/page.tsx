...
const canonicalUrl = getCanonicalUrl('/tenancy-agreement-template-northern-ireland');

export const metadata: Metadata = {
  title: 'Tenancy Agreement Template Northern Ireland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Tenancy Agreement Template Northern Ireland.',
...
export default function TenancyAgreementTemplateNorthernIrelandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_tenancy_agreement_template_northern_ireland&topic=tenancy',
  };
