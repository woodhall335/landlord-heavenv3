...
export const metadata: Metadata = {
  title: 'Tenancy Agreement Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Tenancy Agreement Template.',
...
export default function TenancyAgreementTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_tenancy_agreement_template&topic=tenancy',
  };
