...
export const metadata: Metadata = {
  title: 'Tenancy Agreement | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Tenancy Agreement.',
...
export default function TenancyAgreementPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_tenancy_agreement&topic=tenancy',
  };
