...
const canonicalUrl = getCanonicalUrl('/tenant-damaging-property');

export const metadata: Metadata = {
  title: 'Tenant Damaging Property | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Tenant Damaging Property.',
...
export default function TenantDamagingPropertyPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_tenant_damaging_property&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Tenant Damaging Property'}
