...
const canonicalUrl = getCanonicalUrl('/tenant-not-paying-rent');

export const metadata: Metadata = {
  title: 'Tenant Not Paying Rent | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Tenant Not Paying Rent.',
...
export default function TenantNotPayingRentPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_tenant_not_paying_rent&topic=tenancy',
  };
