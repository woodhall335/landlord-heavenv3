...
const canonicalUrl = getCanonicalUrl('/tenant-wont-leave');

export const metadata: Metadata = {
  title: 'Tenant Wont Leave | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Tenant Wont Leave.',
...
export default function TenantWontLeavePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_tenant_wont_leave&topic=eviction',
  };
