...
export default function RentDemandLetterGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Footer disclaimers
      page.drawText('FREE VERSION - This is a basic template only. Not for legal proceedings.', {
        x: 50,
        y: 80,
        size: 8,
        font: boldFont,
      ...
      page.drawText('For legally validated, court-compliant demand letters, upgrade to the paid version (£14.99).', {
        x: 50,
        y: 65,
        size: 8,
        font: regularFont,
    ...
    >
      ...
      <form className="space-y-6">
        ...
        >
          {isGenerating
            ? 'Generating Letter...'
            : 'Generate Free Letter (Watermarked)'}
        </button>
