...
export default function FreeSection8Tool() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <UniversalHero
        badge="Free Tool"
        title="Create a Section 8 Notice Template (England)"
        subtitle="Create a free Section 8 notice template with the grounds for possession you need."
        align="center"
        hideMedia
        showReviewPill={false}
        showUsageCounter
        primaryCta={{ label: 'Start Free Generator →', href: '#generator' }}
        secondaryCta={{ label: `Get Court-Ready Pack — ${noticeOnlyPrice}`, href: '/products/notice-only?product=section8' }}
      >
