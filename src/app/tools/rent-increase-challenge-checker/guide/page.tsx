...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'form 4a checker',
    'how to use rent increase checker',
    'section 13 rent increase guide',
    'form 4a market rent guide',
    'landlord rent increase tool guide',
    'supportable rent increase guide',
    'rent increase challenge risk guide',
    'section 13 evidence checker',
    'england landlord rent checker',
  ],
