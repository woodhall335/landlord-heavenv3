...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'section 13 market rent calculator',
    'form 4a rent calculator',
    'supportable rent increase calculator',
    'landlord rent increase calculator england',
    'rent increase evidence calculator',
    'tenant challenge risk calculator',
    'section 13 rent checker',
    'market rent comparison tool',
  ],
