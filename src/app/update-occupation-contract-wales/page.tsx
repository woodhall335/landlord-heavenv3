...
const canonicalUrl = getCanonicalUrl('/update-occupation-contract-wales');

export const metadata: Metadata = {
  title: 'Update Occupation Contract Wales | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Update Occupation Contract Wales.',
...
export default function UpdateOccupationContractWalesPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_update_occupation_contract_wales&topic=tenancy',
  };
