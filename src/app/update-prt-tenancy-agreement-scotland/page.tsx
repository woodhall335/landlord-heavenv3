...
const canonicalUrl = getCanonicalUrl('/update-prt-tenancy-agreement-scotland');

export const metadata: Metadata = {
  title: 'Update Prt Tenancy Agreement Scotland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Update Prt Tenancy Agreement Scotland.',
...
export default function UpdatePrtTenancyAgreementScotlandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_update_prt_tenancy_agreement_scotland&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Update Prt Tenancy Agreement Scotland'}
