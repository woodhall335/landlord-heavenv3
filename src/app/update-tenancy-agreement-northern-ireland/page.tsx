...
const canonicalUrl = getCanonicalUrl('/update-tenancy-agreement-northern-ireland');

export const metadata: Metadata = {
  title: 'Update Tenancy Agreement Northern Ireland | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Update Tenancy Agreement Northern Ireland.',
...
export default function UpdateTenancyAgreementNorthernIrelandPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_update_tenancy_agreement_northern_ireland&topic=tenancy',
  };
