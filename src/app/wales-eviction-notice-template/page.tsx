...
const canonicalUrl = getCanonicalUrl('/wales-eviction-notice-template');

export const metadata: Metadata = {
  title: 'Wales Eviction Notice Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Wales Eviction Notice Template.',
...
export default function WalesEvictionNoticeTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_wales_eviction_notice_template&topic=eviction',
  };
