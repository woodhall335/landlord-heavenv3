...
export const metadata: Metadata = {
  title: 'Wales Eviction Notices | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Wales Eviction Notices.',
...
export default function WalesEvictionNoticesPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_wales_eviction_notices&topic=eviction',
  };
