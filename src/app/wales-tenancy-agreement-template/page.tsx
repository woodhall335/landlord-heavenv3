...
const canonicalUrl = getCanonicalUrl('/wales-tenancy-agreement-template');

export const metadata: Metadata = {
  title: 'Wales Tenancy Agreement Template | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Wales Tenancy Agreement Template.',
...
export default function WalesTenancyAgreementTemplatePage() {
  const primaryCta = {
    ...
    href: '/wizard?product=ast_standard&src=seo_wales_tenancy_agreement_template&topic=tenancy',
  };
  ...
  return (
    <McolStyleScaffold
      ...
      title={'Wales Tenancy Agreement Template'}
