...
const canonicalUrl = getCanonicalUrl('/warrant-of-possession');

export const metadata: Metadata = {
  title: 'Warrant Of Possession | Landlord Heaven',
  description: 'Guide, templates, and practical next steps for Warrant Of Possession.',
...
export default function WarrantOfPossessionPage() {
  const primaryCta = {
    ...
    href: '/wizard?product=notice_only&src=seo_warrant_of_possession&topic=eviction',
  };
