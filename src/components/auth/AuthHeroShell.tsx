    ...
    <>
      ...
      >
        <div className="flex min-h-[calc(100vh-10rem)] items-start justify-center pb-8 pt-2 md:items-center md:py-8">
          <div className="w-full max-w-2xl rounded-3xl border border-white/35 bg-white/15 p-4 shadow-[0_30px_80px_rgba(32,12,71,0.35)] backdrop-blur-md sm:p-6 md:p-8">
            ...
            <div className="mt-6 rounded-2xl border border-white/55 bg-white/80 p-5 text-left shadow-[0_20px_55px_rgba(48,20,100,0.2)] backdrop-blur-sm sm:p-7">
              {children}
            </div>
          </div>
        </div>
