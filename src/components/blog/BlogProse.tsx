...
const blogProseClassName = [
  ...
  'prose-h2:mt-12 prose-h2:mb-5 prose-h2:text-[1.75rem] prose-h2:leading-tight',
  'prose-h3:mt-8 prose-h3:mb-3 prose-h3:text-2xl prose-h3:leading-snug',
  'prose-h4:mt-6 prose-h4:mb-2',
  'prose-p:my-5 prose-p:leading-8 prose-p:text-slate-700',
  ...
  'prose-figure:my-10 prose-figure:overflow-hidden prose-figure:rounded-2xl prose-figure:border prose-figure:border-[#e8ddfb] prose-figure:bg-[#f8f1ff] prose-figure:p-2',
