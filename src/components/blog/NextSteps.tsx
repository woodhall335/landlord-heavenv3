...
function enrichCTA(cta: NextStepsCTA): StepLink {
  const iconMap: Record<string, React.ComponentType<{ className?: string }>> = {
    ...
    '/section-21-notice': FileText,
    '/section-21-ban-uk': Shield,
    '/section-8-notice': FileText,
  ...
  const descriptionMap: Record<string, string> = {
    ...
    '/section-21-notice': 'Live transition guidance for valid older England Section 21 notices',
    '/section-21-ban-uk': 'What the Section 21 ban means for England landlords now',
    '/section-8-notice': 'Use Form 3A with the right grounds, dates, and evidence',
