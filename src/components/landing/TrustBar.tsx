...
const trustBadges = [
  {
    ...
    label: 'Built for landlords in England',
  },
  {
    icon: <RiLockLine className="h-5 w-5" />,
    label: 'Current Section 8 route',
    sublabel: 'Written for the rules after 1 May 2026',
  },
  {
    icon: <RiShieldCheckLine className="h-5 w-5" />,
    label: 'Checks before you serve or file',
  },
  {
    icon: <RiMapPinLine className="h-5 w-5" />,
    label: 'Clear routes across notice, court, debt, rent, and tenancy',
  },
];
