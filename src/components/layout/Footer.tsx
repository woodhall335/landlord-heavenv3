    ...
    <footer className="bg-gray-900 text-white">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          {/* Column 2: Products */}
          <div>
            <h5 className="text-base font-bold mb-6 text-primary-400">Products</h5>
            <ul className="space-y-3.5">
              <li>
                <Link
                  href="/products/notice-only"
                  className="text-sm text-white hover:text-gray-300 transition-colors inline-block"
                >
                  Notice Only
                </Link>
              </li>
          ...
          {/* Column 3: Legal */}
          <div>
            <h5 className="text-base font-bold mb-6 text-primary-400">Legal</h5>
            <ul className="space-y-3.5">
              <li>
                <Link
                  href="/terms"
          ...
          {/* Column 4: Account */}
          <div>
            <h5 className="text-base font-bold mb-6 text-primary-400">Account</h5>
            <ul className="space-y-3.5">
              <li>
                <Link
                  href="/auth/login"
