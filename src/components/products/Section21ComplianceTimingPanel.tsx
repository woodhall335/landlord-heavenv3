    ...
    <div className="space-y-6 md:space-y-8">
      <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-[#7c3aed]/15 bg-white p-6 shadow-sm md:p-8">
          ...
          <p className="mt-4 text-gray-700">
            If you are starting an England possession case now, Section 8 is usually the main
            route. The first question is not "which form do I like?" It is "what actually
            happened, and what can I prove?"
          </p>
          <p className="mt-4 text-gray-700">
            Older tenancies can still raise historic paperwork questions, so if your tenancy or
            notice dates cross the changeover, check that first before you serve anything.
          </p>
      ...
      <div className="rounded-2xl border border-[#7c3aed]/15 bg-white p-6 shadow-sm md:p-8">
        <p className="text-lg font-semibold text-charcoal md:text-xl">
          The mistake that costs time is serving the wrong route before you have checked the basics.
        </p>
        <ul className="mt-4 space-y-3 text-sm text-gray-700 md:text-base">
          ...
          <li className="flex items-start gap-2">
            <span className="mt-2 h-2 w-2 rounded-full bg-[#7c3aed]" />
            <span>Which England grounds may apply, and whether the dates and evidence support them.</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="mt-2 h-2 w-2 rounded-full bg-[#7c3aed]" />
            <span>Whether this is a notice problem, a money claim for unpaid rent, or both.</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="mt-2 h-2 w-2 rounded-full bg-[#7c3aed]" />
