          ...
          <>
            <section className="mb-12">
              <div className="max-w-3xl">
                ...
                <div className="mt-4 space-y-4 text-base leading-8 text-[#546075] md:text-lg">
              ...
              <div className="mt-8 grid gap-5 lg:grid-cols-2">
                {salesContent.defaultPackItems.map((item) => (
                  ...
                  >
                    ...
                    <dl className="mt-4 space-y-4 text-sm leading-7 text-[#546075] md:text-base">
                      <div>
                        <dt className="font-semibold text-[#141B2D]">What it is</dt>
                        <dd>{item.plainEnglish}</dd>
                      </div>
                      <div>
                        <dt className="font-semibold text-[#141B2D]">What it does</dt>
                        <dd>{item.function}</dd>
                      </div>
                      <div>
                        <dt className="font-semibold text-[#141B2D]">Why it is needed</dt>
              ...
              {salesContent.conditionalPackItems?.length ? (
                <div className="mt-8 rounded-[2rem] border border-[#E6DBFF] bg-[#FCFAFF] p-6 shadow-[0_14px_32px_rgba(31,41,55,0.05)] md:p-8">
                  <div className="max-w-3xl">
                    ...
                    {salesContent.conditionalIntro ? (
                      <div className="mt-3 space-y-4 text-base leading-8 text-[#546075]">
                        {salesContent.conditionalIntro}
                      </div>
                    ) : null}
                  </div>
                      ...
                      >
                        <div className="flex items-start justify-between gap-4">
                          ...
                          {item.conditionalLabel ? (
                            <span className="rounded-full border border-[#D7DDF4] bg-[#F7F9FF] px-3 py-1 text-xs font-semibold uppercase tracking-[0.08em] text-[#30446B]">
                              {item.conditionalLabel}
                            </span>
                          ) : null}
                        </div>
              ...
              {salesContent.sampleProof ? <div className="mt-8">{salesContent.sampleProof}</div> : null}
            </section>
