...
const ctaConfig: Record<SeoPageType, CtaConfigEntry> = {
  problem: {
    ...
    sectionDescription: 'Generate a court-ready eviction notice in minutes using the current rules and guided checks.',
    faqTitle: 'Need to Start the Eviction Process?',
    faqDescription: 'Our Notice Only Pack helps you produce the current notice route with service guidance and court-focused checks.',
    icon: FileText,
  },
  court: {
    ...
    sectionDescription: 'Get the court forms you need: N5, N119, witness statements, and filing guidance.',
  ...
  notice: {
    ...
    faqTitle: 'Need a Reliable England Notice?',
    faqDescription: 'Our Notice Only Pack helps you produce the current England notice route and prepare it for service.',
    icon: FileText,
  },
};
