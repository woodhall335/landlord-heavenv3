...
const EVENT_DEFINITIONS: AnalyticsEventDefinition[] = [
  ...
  { name: 'commercial_bridge_clicked', family: 'commercial_bridge_clicked', class: 'interaction', dedupeScope: 'none' },
  { name: 'commercial_bridge_viewed', family: 'commercial_bridge_viewed', class: 'view', dedupeScope: 'page' },
  ...
  { name: 'tool_started', family: 'tool_started', class: 'milestone', dedupeScope: 'session' },
  { name: 'tool_completed', family: 'tool_completed', class: 'milestone', dedupeScope: 'session' },
  { name: 'step_completed', family: 'step_completed', class: 'milestone', dedupeScope: 'none' },
  { name: 'result_viewed', family: 'result_viewed', class: 'view', dedupeScope: 'session' },
  { name: 'email_submitted', family: 'email_submitted', class: 'interaction', dedupeScope: 'none' },
  { name: 'product_cta_clicked', family: 'product_cta_clicked', class: 'interaction', dedupeScope: 'none' },
  { name: 'product_page_viewed', family: 'product_page_viewed', class: 'view', dedupeScope: 'page' },
  { name: 'purchase_completed', family: 'purchase_completed', class: 'milestone', dedupeScope: 'none' },
  { name: 'bundle_cta_clicked', family: 'bundle_cta_clicked', class: 'interaction', dedupeScope: 'none' },
