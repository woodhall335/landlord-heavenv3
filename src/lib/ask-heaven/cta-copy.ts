...
const ASK_HEAVEN_CTA_COPY: Partial<Record<AskHeavenCtaKey, AskHeavenCtaCopy>> = {
  'notice_only:england:eviction': {
    product: 'notice_only',
    title: 'Need to serve a current England notice?',
    description: `Create the right England possession notice with the route, dates, and service checks lined up (${NOTICE_PRICE}).`,
    buttonText: 'Create my Section 8 notice',
    displayPrice: NOTICE_PRICE,
  },
  'notice_only:england:arrears_notice': {
    product: 'notice_only',
    title: 'Rent arrears need a proper notice?',
    description: `Create a current England arrears notice with the grounds, dates, and service record prepared before you serve (${NOTICE_PRICE}).`,
    buttonText: 'Create my Section 8 notice',
    displayPrice: NOTICE_PRICE,
  },
  ...
  'complete_pack:england:eviction': {
    product: 'complete_pack',
    title: 'Need the possession file together?',
