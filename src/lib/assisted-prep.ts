...
export const ASSISTED_PREP_CONFIGS: Record<AssistedPrepService, AssistedPrepConfig> = {
  ...
  possession: {
    ...
    callbackHeadline: 'Want us to prepare the full eviction case with you?',
    primaryCta: 'Book full eviction case prep',
    checklist: [
      'Tenancy agreement',
    ...
    finalChecklistNote: "If you haven't served a notice yet, that's fine - the full-case service can include the notice stage if the consultation confirms it is suitable.",
  },
};
