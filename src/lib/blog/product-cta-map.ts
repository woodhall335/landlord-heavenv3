...
export const BLOG_PRODUCT_ROUTES = {
  ...
  section13Standard: SEO_PRODUCT_ROUTES.section13Standard,
  section13Defence: SEO_PRODUCT_ROUTES.section13Defence,
...
const PRODUCT_REFORM_CTA_OVERRIDES: Record<string, ProductCtaConfig> = {
  ...
  'england-standard-tenancy-agreement-after-1-may-2026': {
    ...
    ctaLabel: 'Create my Standard tenancy pack',
    bullets: [
      'Built for straightforward England tenancies.',
      'Avoids stale fixed-term AST assumptions.',
      'Preview the completed agreement pack before payment.',
    ],
    iconKey: 'ast',
    usedDefault: false,
  },
  'england-premium-tenancy-agreement-after-renters-rights-act': {
    ...
    intro:
      'Use Premium where the tenancy is higher-value, more complex, guarantor-backed, shared, or simply needs a more detailed written record.',
    ctaLabel: 'Create my Premium tenancy pack',
    bullets: [
  ...
  'england-hmo-shared-house-tenancy-agreement-after-renters-rights-act': {
    ...
    ctaLabel: 'Create my HMO / Shared House pack',
    bullets: [
