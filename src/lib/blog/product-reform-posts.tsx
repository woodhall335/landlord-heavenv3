...
const productReformSpecs: ProductReformBlogSpec[] = [
  ...
  },
  {
    ...
    productLabel: 'Standard Section 13 Rent Increase Pack',
    ...
    faqs: ['Is Section 13 still used after 1 May 2026?', 'When is the Standard Section 13 Rent Increase Pack enough?', 'When should I choose the Defence Pack?'],
  ...
  },
  {
    ...
    whenToEscalate: 'If the case is simple and the proposed rent is well inside the supportable local range, the Standard Section 13 Rent Increase Pack is usually the calmer starting point.',
