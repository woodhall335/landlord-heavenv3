...
const productReformSpecs: ProductReformBlogSpec[] = [
  {
    ...
    secondaryKeywords: [
      ...
      'form 3a notice',
      'renters rights act eviction notice',
      'form 3a for landlords',
      'section 8 eviction notice generator',
      'court-ready eviction notice',
      'landlord eviction notice pack',
      'serve form 3a notice',
      'section 8 notice after renters rights act',
    ],
  ...
  },
  {
    ...
    secondaryKeywords: [
      ...
      'n5 n119 eviction pack',
      'section 21 ban landlord',
      'court possession pack',
      'section 8 court pack',
      'possession claim documents',
      'landlord eviction bundle',
      'form n5 n119 landlord',
      'rent arrears possession claim',
      'post section 21 eviction pack',
    ],
  ...
  },
  {
    ...
    secondaryKeywords: [
      ...
      'increase rent after renters rights act',
      'market rent evidence bundle',
      'valid rent increase notice',
      'rent increase tribunal risk',
    ],
    ...
    productLabel: 'Supported Rent Increase Pack',
    ...
    productAlignment: 'The Supported Rent Increase Pack is more than a form. It uses current local comparable listings, market position messaging, and a rent summary so landlords can choose a more supportable figure before serving.',
    ...
    whenToEscalate: 'If you already expect pushback, the evidence looks weak, or the proposed figure sits high against local comparables, use the Tribunal-Ready Rent Increase Pack.',
    faqs: ['Is Section 13 still used after 1 May 2026?', 'When is the Supported Rent Increase Pack enough?', 'When should I choose the Tribunal-Ready Rent Increase Pack?'],
  ...
  },
  {
    ...
    title: 'Tribunal-Ready Rent Increase Pack for Tribunal Challenge Risk',
    ...
    metaDescription: 'Worried about a Section 13 challenge? See how the Tribunal-Ready Rent Increase Pack supports Form 4A, market evidence, and tribunal-facing rent justification.',
    readTime: '10 min read',
    wordCount: 1460,
    category: 'Rent Increase',
    ...
    secondaryKeywords: [
      'section 13 tribunal challenge',
      'rent increase challenge evidence',
      'form 4a dispute',
      'defend rent increase',
      'tenant rent increase challenge',
      'first-tier tribunal rent increase',
      'market rent defence pack',
      'section 13 evidence bundle',
      'rent assessment tribunal evidence',
      'challenge excessive rent increase',
    ],
    ...
    productLabel: 'Tribunal-Ready Rent Increase Pack',
    ...
    productAlignment: 'The Tribunal-Ready Rent Increase Pack adds challenge-response and tribunal-facing material around the Form 4A route, helping landlords organise comparable evidence and explain the proposed rent.',
    ...
    articleAngle: 'Use the Tribunal-Ready Rent Increase Pack where the rent increase may be challenged and the landlord needs a stronger evidence story.',
    ...
    whenToEscalate: 'If the case is simple and the proposed rent is well inside the supportable local range, the Supported Rent Increase Pack is usually the calmer starting point.',
    faqs: ['Do I need tribunal evidence before a tenant challenges?', 'When is the Tribunal-Ready Rent Increase Pack the right product?', 'Can I use the Supported pack if the case is low risk?'],
    sources: [GOV_ASSURED_TENANCY_FORMS_2026, GOV_RENTERS_RIGHTS_GUIDE, RENTERS_RIGHTS_ACT_2025],
  },
  {
    ...
    secondaryKeywords: [
      ...
      'england landlord tenancy agreement',
      'new tenancy agreement 2026',
      'periodic tenancy agreement england',
      'court-ready tenancy agreement',
      'landlord agreement template',
      'renters rights act compliant agreement',
    ],
  ...
  },
  {
    ...
    secondaryKeywords: [
      ...
      'landlord tenancy agreement protection',
      'renters rights act tenancy wording',
      'strong tenancy agreement',
      'advanced tenancy agreement clauses',
      'landlord protective tenancy terms',
      'premium landlord agreement template',
      'england tenancy agreement upgrade',
      'renters rights act landlord clauses',
      'high protection tenancy agreement',
    ],
  ...
  },
  {
    ...
    secondaryKeywords: [
      ...
      'student let agreement',
      'renters rights act student landlord',
      'student house tenancy agreement',
      'joint student tenancy agreement',
      'student landlord agreement template',
      'student HMO tenancy agreement',
      'fixed term student let clauses',
      'university landlord agreement',
      'renters rights act student lets',
    ],
  ...
  },
  {
    ...
    secondaryKeywords: [
      ...
      'renters rights act hmo landlord',
      'hmo landlord agreement',
      'room-only tenancy agreement',
      'joint and several HMO agreement',
      'shared house landlord agreement',
      'hmo licence tenancy clauses',
      'multi-let tenancy agreement',
      'renters rights act shared house',
    ],
  ...
  },
  {
    ...
    secondaryKeywords: [
      ...
      'renters rights act lodger',
      'excluded occupier agreement',
      'live-in landlord lodger agreement',
      'lodger room licence',
      'resident landlord notice rules',
      'lodger contract template',
      'lodger agreement after renters rights act',
    ],
