...
> = {
  ...
  'england-standard-tenancy-agreement-after-1-may-2026': {
    ...
    anchorText: 'Build my validated Standard pack',
    description: 'Build a current England setup pack for straightforward lets from your facts.',
  ...
  'england-premium-tenancy-agreement-after-renters-rights-act': {
    ...
    anchorText: 'Build my validated Premium pack',
    description: 'Build a more detailed England setup pack for higher-risk lets.',
  ...
  'england-student-tenancy-agreement-after-renters-rights-act': {
    ...
    anchorText: 'Build my validated Student pack',
    description: 'Build an England setup pack shaped around student-let practicalities.',
  ...
  'england-hmo-shared-house-tenancy-agreement-after-renters-rights-act': {
    ...
    anchorText: 'Build my validated HMO / Shared House pack',
    description: 'Build shared-occupation paperwork for HMOs and shared houses.',
    secondaryHref: '/premium-tenancy-agreement',
    secondaryLabel: 'Premium Tenancy Agreement',
  },
  'england-lodger-agreement-after-renters-rights-act': {
    ...
    anchorText: 'Build my validated Lodger pack',
    description: 'Build resident-landlord paperwork for a lodger arrangement.',
    secondaryHref: '/standard-tenancy-agreement',
    secondaryLabel: 'Standard Tenancy Agreement',
  },
};
