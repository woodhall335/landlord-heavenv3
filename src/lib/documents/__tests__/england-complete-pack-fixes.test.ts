 ...
 * 1. Price mismatch (£34.99 -> £49.99) - P0 Critical
...
describe('Complete Pack Integration', () => {
  it('should have consistent pricing across all sources', () => {
    // All sources must agree on £49.99
    ...
    expect(priceFromProducts).toBe(49.99);
    expect(priceFromRegional).toBe(49.99);
    expect(priceFromFunction).toBe(49.99);
