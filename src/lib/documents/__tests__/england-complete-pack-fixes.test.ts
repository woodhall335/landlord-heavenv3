 ...
 * 1. Price mismatch (legacy lower price -> current complete-pack price) - P0 Critical
...
describe('Complete Pack Integration', () => {
  it('should have consistent pricing across all sources', () => {
    // All sources must agree on the current complete-pack price
    ...
    expect(priceFromProducts).toBe(79.99);
    expect(priceFromRegional).toBe(79.99);
    expect(priceFromFunction).toBe(79.99);
