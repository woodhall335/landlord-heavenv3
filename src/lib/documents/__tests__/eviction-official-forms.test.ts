...
describe('England eviction official forms', () => {
  ...
  it('prefills the core editable N215 fields that the packs rely on', async () => {
    ...
    expect(fields.get('Text Field 93')).toBe('25042026');
    expect(fields.get('Text Field 94')).toBe('29042026');
    expect(String(fields.get('Text Field 93'))).not.toContain('/');
    expect(String(fields.get('Text Field 94'))).not.toContain('/');
    ...
    expect(fields.get('Text Field 88')).toBe('2026');
