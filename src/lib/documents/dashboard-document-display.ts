...
export function getDashboardDocumentTitle(documentType: string): string {
  const explicitTitles: Record<string, string> = {
    ...
    evidence_checklist: 'Evidence Required for Hearing',
    proof_of_service: 'Certificate of Service (Form N215)',
    court_readiness_status: 'Court Readiness Status',
    court_forms_guide: 'Court Forms',
    service_record_notes: 'Service Continuity Notes',
    hearing_checklist: 'Hearing Preparation Guide',
