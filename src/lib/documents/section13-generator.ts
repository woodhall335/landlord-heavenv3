...
const SECTION13_TRIBUNAL_WARNING =
  'The tenant can refer the proposed rent to the tribunal up to the day before the proposed start date. The tribunal will determine the open-market rent, which may be higher or lower than the figure proposed, but the tenant will not be required to pay more than the amount first proposed in Form 4A.';
