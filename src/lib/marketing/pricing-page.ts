...
export const PRICING_PACKAGE_CARDS: PricingPackageCard[] = [
  ...
  {
    name: 'England Tenancy Agreement - Standard',
  ...
  {
    name: 'England Tenancy Agreement - Premium',
  ...
  {
    name: 'Wales Standard Occupation Contract',
    productSku: 'ast_standard',
    price: PRODUCTS.ast_standard.displayPrice,
    coverage: 'For landlords in Wales',
    bestFor: 'You need a Wales Standard Occupation Contract for a suitable private residential let.',
    points: [
      'Choose a Fixed-Term or Periodic Standard Occupation Contract',
      'Uses Wales-specific terminology and wizard questions',
      'Preview the generated contract and supporting pack before payment',
    ],
    href: '/tenancy-agreements/wales',
    cta: 'Choose the Wales contract type',
  },
  {
    name: 'Scotland Standard PRT',
    productSku: 'ast_standard',
    price: PRODUCTS.ast_standard.displayPrice,
    coverage: 'For landlords in Scotland',
    bestFor: 'You need the released Standard Private Residential Tenancy for a suitable Scottish let.',
    points: [
      'Uses the open-ended Scotland PRT framework',
      'Includes Scotland-specific wizard questions and supporting notes',
      'Preview the generated agreement and supporting pack before payment',
    ],
    href: '/tenancy-agreements/scotland',
    cta: 'Create the Scotland PRT',
  },
  {
    name: 'Northern Ireland Standard Tenancy Agreement',
    productSku: 'ast_standard',
    price: PRODUCTS.ast_standard.displayPrice,
    coverage: 'For landlords in Northern Ireland',
    bestFor: 'You need the released Standard NI Private Tenancy Agreement and supporting-document workflow.',
    points: [
      'Uses Northern Ireland-specific terminology and questions',
      'Includes the Tenancy Information Notice workflow and NI supporting documents',
      'Preview the generated agreement and supporting pack before payment',
    ],
    href: '/tenancy-agreements/northern-ireland',
    cta: 'Create the NI agreement',
  },
  {
