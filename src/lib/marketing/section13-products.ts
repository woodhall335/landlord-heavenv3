...
export const SECTION13_STANDARD_PAGE: Section13ProductPageConfig = {
  ...
  description:
    'Prepare a Section 13 rent increase for England with Form 4A, a market-rent justification report, and proof of service in one pack.',
  heroTitle: 'Section 13 Rent Increase Pack for England landlords',
  heroSubtitle:
    'If you want to raise the rent properly, this pack helps you check the timing first, set out the figure clearly, and serve a stronger Form 4A file.',
  ...
  whoItsFor: [
    'You want to propose a new rent and need the formal England Section 13 notice.',
    'You want to check dates, comparables, and the proposed figure before serving the notice.',
    'You want the notice, report, and proof of service kept together in one landlord file.',
  ],
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'That matters because a Section 13 notice reads more naturally and feels more credible when the date, the figure, and the reasoning all line up. If the tenant asks why the increase is being proposed, you already have a straightforward answer ready.',
      ],
    },
    {
...
export const SECTION13_DEFENCE_PAGE: Section13ProductPageConfig = {
  ...
  heroSubtitle:
    'If the tenant is likely to challenge the increase, this pack helps you move from serving the notice to being ready to explain and defend the file properly.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'It gives you a fuller set of landlord documents so the notice does not stand alone. Instead, the case reads as one consistent file with a clear position, a clear evidence trail, and a more organised response path if the tenant disputes the increase.',
      ],
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'Yes. The Defence Pack is built for England landlords using Section 13 when a challenge is likely.',
    },
  ],
};
