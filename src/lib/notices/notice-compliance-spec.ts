...
export const noticeComplianceSpecs: NoticeComplianceSpec[] = [
  {
    ...
    template_paths: ['config/jurisdictions/uk/england-wales/templates/eviction/section8_notice.hbs'],
  ...
  },
  {
    ...
    template_paths: ['config/jurisdictions/uk/england-wales/templates/eviction/section21_form6a.hbs'],
  ...
  },
  {
    ...
    template_paths: ['config/jurisdictions/uk/wales/templates/eviction/section173_landlords_notice.hbs'],
  ...
  },
  {
    ...
    template_paths: ['config/jurisdictions/uk/scotland/templates/eviction/notice_to_leave.hbs'],
