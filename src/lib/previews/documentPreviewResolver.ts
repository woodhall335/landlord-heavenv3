...
export const DOCUMENT_PREVIEW_TYPE_MAPPING: Record<string, string[]> = {
  ...
  'form-e': ['form_e_tribunal', 'form_e', 'tribunal_application'],
  ...
  'validity-checklist-s173': ['validity_checklist', 'service_checklist'],
  'validity-checklist-fault': ['validity_checklist', 'service_checklist'],
  'validity-checklist-ntl': ['validity_checklist', 'service_checklist'],
  ...
  'pre-service-checklist-fault': ['pre_service_compliance_checklist', 'compliance_checklist', 'pre_service_compliance'],
