...
describe('Complete Pack temporary price regression checks', () => {
  it('keeps all central complete_pack price sources aligned at 99.99', () => {
    expect(SEO_PRICES.evictionBundle.amount).toBe(99.99);
    expect(SEO_PRICES.evictionBundle.display).toBe('£99.99');
