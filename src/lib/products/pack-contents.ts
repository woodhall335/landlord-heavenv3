...
function getEnglandCompletePackContents(args: GetPackContentsArgs): PackItem[] {
  ...
  return [
    ...
    },
    {
      ...
      description: 'Court-ready witness statement tying the tenancy, notice, service, arrears, and possession claim into one evidential narrative.',
      category: 'Court forms',
      required: true,
    },
    {
      ...
      description: 'Indexed filing list for the notice, official forms, evidence, and witness material included in the possession bundle.',
      category: 'Evidence',
      required: true,
    },
    {
    ...
    },
    {
      key: 'service_instructions',
      title: 'Service Instructions',
      description: `Service playbook to keep the ${ENGLAND_SECTION8_NOTICE_NAME}, Form N215, and court file aligned on method, date, and evidence.`,
      category: 'Guidance',
      required: true,
    },
  ];
