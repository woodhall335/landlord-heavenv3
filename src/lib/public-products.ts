...
export const PUBLIC_PRODUCT_DESCRIPTORS: Record<PublicProductKey, PublicProductDescriptor> = {
  notice_only: {
    ...
    seoTitle: 'Stage 1: Section 8 Eviction Notice & Service Pack',
    metaDescription:
      'Create an England Section 8 eviction notice and service file with Form 3A, N215, arrears schedule, service steps, and checks.',
    eyebrow: 'Stage 1: notice & service',
    heroBadge: 'For landlords in England',
    proofLabel: 'Solicitor-approved notice and service file',
    cardAccent: 'amethyst',
    ctaLabel: `Create and preview my Form 3A — ${PRODUCTS.notice_only.displayPrice}`,
    primaryCtaLabel: `Create and preview my Form 3A — ${PRODUCTS.notice_only.displayPrice}`,
  ...
  complete_pack: {
    ...
    seoTitle: 'Stage 2: Section 8 Possession Claim Pack',
    metaDescription:
      'Prepare an England Section 8 possession claim pack with the notice, service record, N5, N119, evidence, and hearing support.',
  ...
  money_claim: {
    ...
    seoTitle: 'Rent Arrears Money Claim Pack (England)',
    metaDescription:
      'Recover unpaid rent or tenant debt with a landlord money claim pack covering letter before claim, particulars, debt schedule, and MCOL/N1 guidance.',
    eyebrow: 'Money claim',
    heroBadge: 'For landlords in England',
  ...
  section13_standard: {
    ...
    seoTitle: 'Form 4A Rent Increase Pack With Market Evidence',
    metaDescription:
  ...
  section13_defensive: {
    ...
    seoTitle: 'Section 13 Rent Challenge Pack',
    metaDescription:
