...
export const PUBLIC_PRODUCT_DESCRIPTORS: Record<PublicProductKey, PublicProductDescriptor> = {
  ...
  section13_standard: {
    ...
    metaDescription:
      'Propose an England rent increase with Form 4A, timing checks, market evidence, and a clear service record.',
    eyebrow: 'Rent increase',
    heroBadge: 'Built for properties in England',
    proofLabel: 'Form 4A, evidence, and service record',
    cardAccent: 'amber',
  ...
  section13_defensive: {
    ...
    metaDescription:
      'Prepare an England Section 13 rent increase file for tenant challenge with stronger evidence, reply tools, and bundle support.',
    eyebrow: 'Rent increase',
    heroBadge: 'Built for properties in England',
    proofLabel: 'Prepare for tenant challenge',
    cardAccent: 'amber',
