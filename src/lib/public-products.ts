...
export const PUBLIC_PRODUCT_DESCRIPTORS: Record<PublicProductKey, PublicProductDescriptor> = {
  ...
  complete_pack: {
    ...
    heroPreset: 'product_owner',
    themeKey: 'court',
    displayName: 'Section 8 Complete Eviction Pack',
    shortName: 'Section 8 Complete Eviction Pack',
    seoTitle: 'Section 8 Complete Eviction Pack (Court Possession - England)',
    metaDescription:
      'Prepare the England court-possession papers with a Section 8 notice, N5, N119, possession claim drafting, and filing guidance in one pack.',
    eyebrow: 'Section 8 court possession',
    heroBadge: 'For landlords in England',
    proofLabel: 'Section 8 notice, court forms, and filing guidance together',
    cardAccent: 'plum',
    ctaLabel: 'Start Section 8 Complete Eviction Pack',
    primaryCtaLabel: 'Start Section 8 Complete Eviction Pack',
  ...
  section13_standard: {
    ...
    heroPreset: 'product_owner',
    themeKey: 'rent',
    displayName: 'Standard Section 13 Pack',
    shortName: 'Standard Section 13 Pack',
    seoTitle: 'Standard Section 13 Pack (England)',
    metaDescription:
      'Increase rent in England using Section 13 and Form 4A with timing checks, support notes, and landlord guidance.',
    eyebrow: 'Rent increase',
    heroBadge: 'Built for properties in England',
    proofLabel: 'Section 13 and Form 4A support',
    cardAccent: 'amber',
    ctaLabel: 'Start Standard Section 13 Pack',
    primaryCtaLabel: 'Start Standard Section 13 Pack',
  ...
  section13_defensive: {
    ...
    metaDescription:
      'Prepare an England Section 13 defence file with fuller challenge support, evidence tools, and tribunal preparation.',
    eyebrow: 'Rent increase',
    heroBadge: 'Built for properties in England',
    proofLabel: 'Landlord file support when the increase may be challenged',
    cardAccent: 'amber',
    ctaLabel: 'Start Challenge-Ready Section 13 Defence Pack',
    primaryCtaLabel: 'Start Challenge-Ready Section 13 Defence Pack',
    secondaryCtaLabel: 'Read the rent increase guide',
  ...
  england_standard_tenancy_agreement: {
    ...
    metaDescription:
      'Create a Standard Tenancy Agreement for a straightforward England whole-property let.',
  ...
  england_lodger_agreement: {
    ...
    metaDescription:
      'Create an England lodger agreement for a resident-landlord room let without forcing the arrangement into a whole-property tenancy agreement.',
    eyebrow: 'England agreement',
    heroBadge: 'For landlords in England',
