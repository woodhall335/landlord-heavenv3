...
export const PUBLIC_PRODUCT_DESCRIPTORS: Record<PublicProductKey, PublicProductDescriptor> = {
  notice_only: {
    ...
    metaDescription:
      'Start the eviction process correctly with a Section 8 notice pack for England that aligns the notice, service, and evidence before you serve.',
    eyebrow: 'Stage 1: notice & service',
    heroBadge: 'For landlords in England',
    proofLabel: 'Built to hold up if challenged',
    cardAccent: 'amethyst',
  ...
  complete_pack: {
    ...
    metaDescription:
      'Complete England Section 8 pack covering both the notice/service stage and the court stage, with the notice, service record, N5, N119, and evidence aligned in one possession file.',
    eyebrow: 'Stage 2: court & possession',
    heroBadge: 'For landlords in England',
    proofLabel: 'Includes Stage 1 notice and Stage 2 court documents together',
    cardAccent: 'plum',
