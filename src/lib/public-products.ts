...
export const PUBLIC_PRODUCT_DESCRIPTORS: Record<PublicProductKey, PublicProductDescriptor> = {
  notice_only: {
    ...
    metaDescription:
      'Prepare a solicitor-approved Section 8 notice and service file for England with Form 3A, N215, arrears schedule, service steps, and checks.',
    eyebrow: 'Stage 1: notice & service',
    heroBadge: 'For landlords in England',
    proofLabel: 'Solicitor-approved notice and service file',
    cardAccent: 'amethyst',
  ...
  complete_pack: {
    ...
    metaDescription:
      'Prepare a solicitor-approved Section 8 court and possession file for England with the notice, service record, N5, N119, evidence, and hearing support.',
  ...
  money_claim: {
    ...
    metaDescription:
      'Prepare an England money claim for unpaid rent, damage, bills, guarantor debt, or other tenancy debt.',
    eyebrow: 'Money claim',
    heroBadge: 'For landlords in England',
    proofLabel: 'Claim rent, bills, damage, or guarantor debt',
    cardAccent: 'emerald',
  ...
  section13_standard: {
    ...
    shortName: 'Supported Rent Increase Pack',
    seoTitle: 'Supported Rent Increase Pack (Section 13, England)',
    metaDescription:
      'Prepare a market-supported England rent increase with Form 4A, current local market comparables, timing checks, cover letter, and service record.',
    eyebrow: 'Rent increase',
    heroBadge: 'Built for properties in England',
    proofLabel: 'Form 4A, market evidence, and service record',
    cardAccent: 'amber',
  ...
  section13_defensive: {
    ...
    heroPreset: 'product_owner',
    themeKey: 'rent',
    displayName: 'Tribunal-Ready Rent Increase Pack',
    shortName: 'Tribunal-Ready Rent Increase Pack',
    seoTitle: 'Tribunal-Ready Rent Increase Pack (Section 13, England)',
    metaDescription:
      'Prepare an England Section 13 rent increase file for tenant challenge with current market comparables, response tools, legal briefing, and indexed bundle support.',
    eyebrow: 'Rent increase',
    heroBadge: 'Built for properties in England',
    proofLabel: 'Market evidence and tribunal-ready structure',
    cardAccent: 'amber',
    ctaLabel: 'Prepare for a rent challenge',
    primaryCtaLabel: 'Prepare for a rent challenge',
    secondaryCtaLabel: 'Read the rent increase guide',
  ...
  ast: {
    ...
    heroBadge: 'For landlords in England',
    proofLabel: 'Five England agreement options',
    cardAccent: 'lavender',
  ...
  england_hmo_shared_house_tenancy_agreement: {
    ...
    cardAccent: 'lavender',
    ctaLabel: 'Create my HMO agreement',
