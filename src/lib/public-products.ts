...
export const PUBLIC_PRODUCT_DESCRIPTORS: Record<PublicProductKey, PublicProductDescriptor> = {
  notice_only: {
    ...
    metaDescription:
      'Prepare a Section 8 notice pack for England with the notice, service steps, and evidence checks lined up before you serve.',
    eyebrow: 'Stage 1: notice & service',
    heroBadge: 'For landlords in England',
    proofLabel: 'Serve the notice before court',
    cardAccent: 'amethyst',
  ...
  complete_pack: {
    ...
    metaDescription:
      'Prepare an England Section 8 possession pack with the notice, service record, N5, N119, and evidence kept together in one court file.',
