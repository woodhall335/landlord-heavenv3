...
export interface Section13MarketCalculation {
  ...
  justifiedMarketLow: number | null;
  justifiedMarketMedian: number | null;
  justifiedMarketHigh: number | null;
...
export interface Section13PreviewMetrics {
  ...
  rawLowerQuartile: number | null;
  rawMedian: number | null;
  rawUpperQuartile: number | null;
