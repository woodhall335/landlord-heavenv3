...
const dedupeLinksByHref = <T extends { href: string }>(links: readonly T[]): T[] =>
  links.filter(
...
export const productLinks = {
  ...
  tenancyAgreement: {
    href: '/products/ast',
    title: 'England Tenancy Agreements for Landlords',
    description: 'Compare and start the right England tenancy agreement route for the let.',
    icon: 'document' as const,
    type: 'product' as const,
  },
...
export const toolLinks = {
  section21Generator: {
    ...
    title: 'Current England Notice Workflow',
    description: 'Start the current England notice generator route.',
    icon: 'document' as const,
    type: 'tool' as const,
  },
  section8Generator: {
  ...
  section21Validator: {
    ...
    title: 'England Notice Hub',
    description: 'Review the current England notice route and next steps.',
    icon: 'legal' as const,
    type: 'tool' as const,
  },
  section8Validator: {
    ...
    description: 'Read the current grounds, notice periods, and possession workflow.',
    icon: 'legal' as const,
    type: 'tool' as const,
  },
  rentDemandLetter: {
...
export const blogLinks = {
  whatIsSection21: {
    ...
    title: 'Historical notice transition guide',
    description: 'Understand older notice terminology and move to the current England route',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  section21VsSection8: {
    href: '/section-21-vs-section-8',
    title: 'Historical comparison transition guide',
    description: 'Translate older comparison searches into the current England route',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  howToServeNotice: {
...
export const landingPageLinks = {
  section21Template: {
    ...
    description: 'Broad England notice owner for landlords who need to evict a tenant legally.',
    icon: 'document' as const,
    type: 'page' as const,
  },
  evictionTemplate: {
    ...
    description: 'Broad pre-court eviction owner for landlords who need the right notice.',
    icon: 'document' as const,
    type: 'page' as const,
  },
  section8Template: {
    ...
    title: 'Form 3A Guide',
    description: 'Current England Form 3A notice guidance',
    icon: 'document' as const,
    type: 'page' as const,
  },
  rentArrearsTemplate: {
  ...
  tenancyTemplate: {
    ...
    description: 'Support page with a real England example and a route into the product pages.',
    icon: 'document' as const,
    type: 'page' as const,
  },
  walesEvictionTemplate: {
    ...
    description: 'Compare the England notice product and the paperwork it includes.',
    icon: 'document' as const,
    type: 'page' as const,
  },
...
export const guideLinks = {
  howToEvictTenant: {
    ...
    description: 'UK comparison guide that routes England landlords into the current framework.',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  evictionProcessUk: {
    ...
    description: 'UK process overview that routes England cases into the post-1 May 2026 workflow.',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  rentersRightsActEvictionRules: {
    href: '/renters-rights-act-eviction-rules',
    title: "Renters' Rights Act Eviction Rules",
    description: 'Current England eviction rules after 1 May 2026.',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  section8Notice: {
    ...
    description: 'Section 8 notice guidance covering grounds, evidence and service.',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  form3aSection8: {
    href: '/form-3-section-8',
    title: 'Form 3A',
    description: 'England guidance for Form 3A and the Section 8 notice route.',
    icon: 'document' as const,
    type: 'guide' as const,
  },
  howToEvictTenantEngland: {
    href: '/how-to-evict-a-tenant-england',
    title: 'How to Evict a Tenant in England',
    description: 'Current England step-by-step guide for landlords after 1 May 2026.',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  evictionProcessEngland: {
    href: '/eviction-process-england',
    title: 'Eviction Process in England',
    description: 'Current England notice-to-court possession process for landlords.',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  section21Notice: {
    href: '/section-21-notice',
    title: 'England Transition Guide',
    description: 'Historical transition guide for older notice terminology',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  section21BanUk: {
    href: '/section-21-ban-uk',
    title: 'England Framework Change Guide',
    description: 'Current framework overview for landlords moving into live England rules',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  walesEviction: {
    href: '/products/notice-only',
    title: 'England Eviction Notice Generator',
    description: 'Compare the public notice product for landlords in England.',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  scotlandEviction: {
  ...
  moneyClaimGuide: {
    href: '/products/money-claim',
    title: 'Landlord Money Claim Pack',
    description:
      'Recover unpaid rent, damage, and tenant debt with the landlord money claim pack.',
    icon: 'legal' as const,
    type: 'guide' as const,
  },
  tenantWontLeave: {
  ...
  n5bFormGuide: {
    ...
    description: 'Current possession claim guidance for England',
    icon: 'document' as const,
    type: 'guide' as const,
  },
  warrantOfPossession: {
...
export const currentEnglandFrameworkLinks = dedupeLinksByHref([
...
export function getCurrentEnglandFrameworkLinks(currentPathname?: string) {
  return currentEnglandFrameworkLinks.filter((link) => link.href !== currentPathname);
}
...
export const evictionRelatedLinks = dedupeLinksByHref([
...
export const section21RelatedLinks = dedupeLinksByHref([
  productLinks.noticeOnly,
  ...currentEnglandFrameworkLinks,
  landingPageLinks.evictionTemplate,
  guideLinks.section21Notice,
...
export const rentArrearsRelatedLinks = dedupeLinksByHref([
...
export const moneyClaimRelatedLinks = dedupeLinksByHref([
  guideLinks.moneyClaimGuide,
  moneyClaimGuides.unpaidRent,
...
export const rentArrearsWithAdviceLinks = dedupeLinksByHref([
  askHeavenLink,
  guideLinks.moneyClaimGuide,
  productLinks.moneyClaim,
  toolLinks.rentDemandLetter,
...
export const tenantNotPayingRentRelatedLinks = dedupeLinksByHref([
...
export const possessionClaimRelatedLinks = dedupeLinksByHref([
  productLinks.completePack,
  productLinks.noticeOnly,
...
export const evictionCostRelatedLinks = dedupeLinksByHref([
  guideLinks.howToEvictTenant,
  guideLinks.evictionProcessUk,
  guideLinks.section8Notice,
  guideLinks.section21BanUk,
...
export const n5bFormRelatedLinks = dedupeLinksByHref([
  productLinks.completePack,
  guideLinks.possessionClaimGuide,
  guideLinks.warrantOfPossession,
  landingPageLinks.section21Template,
...
export const moneyClaimHubLinks = dedupeLinksByHref([
  guideLinks.moneyClaimGuide,
  moneyClaimGuides.unpaidRent,
...
export const moneyClaimDamageLinks = dedupeLinksByHref([
  guideLinks.moneyClaimGuide,
  moneyClaimGuides.propertyDamage,
...
export const moneyClaimCleaningLinks = dedupeLinksByHref([
  guideLinks.moneyClaimGuide,
  moneyClaimGuides.cleaningCosts,
...
export const moneyClaimUtilitiesLinks = dedupeLinksByHref([
  guideLinks.moneyClaimGuide,
  moneyClaimGuides.unpaidBills,
  moneyClaimGuides.unpaidUtilities,
...
export const moneyClaimRentLinks = dedupeLinksByHref([
  guideLinks.moneyClaimGuide,
  moneyClaimGuides.unpaidRent,
  moneyClaimGuides.formerTenant,
...
export const moneyClaimProcessLinks = dedupeLinksByHref([
  guideLinks.moneyClaimGuide,
  moneyClaimGuides.mcolProcess,
...
export const moneyClaimEnforcementLinks = dedupeLinksByHref([
  guideLinks.moneyClaimGuide,
  moneyClaimGuides.ccjEnforcement,
  moneyClaimGuides.formerTenant,
  productLinks.moneyClaim,
...
export const moneyClaimFormLinks = dedupeLinksByHref([
  guideLinks.moneyClaimGuide,
  moneyClaimForms.letterBeforeAction,
...
export const moneyClaimBlogSidebarLinks = dedupeLinksByHref([
  guideLinks.moneyClaimGuide,
  moneyClaimGuides.unpaidRent,
  moneyClaimGuides.propertyDamage,
  moneyClaimGuides.cleaningCosts,
...
export const tenancySeoEnglandPages = {
  astMain: {
    href: '/assured-shorthold-tenancy-agreement-template',
    title: 'AST Legacy Guide',
    description: 'Legacy AST terminology routed into the main England agreement example page',
    icon: 'document' as const,
    type: 'page' as const,
  },
  astTemplate: {
    ...
    description: 'Older AST template terminology explained for England',
    icon: 'document' as const,
    type: 'page' as const,
  },
  fixedTermPeriodic: {
...
export const tenancyFunnelPages = {
  englandHub: {
    ...
    title: 'England Tenancy Agreements for Landlords',
    description:
      'Compare the current England agreements and choose the one that fits the property and occupiers.',
    icon: 'document' as const,
    type: 'page' as const,
  },
  standardTenancyAgreement: {
    href: '/standard-tenancy-agreement',
    title: 'Standard Tenancy Agreement & Setup Pack',
    description: 'For straightforward whole-property residential lets in England.',
    icon: 'document' as const,
    type: 'page' as const,
  },
  premiumTenancyAgreement: {
    href: '/premium-tenancy-agreement',
    title: 'Premium Tenancy Agreement & Management Pack',
    description: 'For ordinary residential lets that need fuller management and operational detail.',
    icon: 'document' as const,
    type: 'page' as const,
  },
  ...
  astAgreementTemplate: {
    href: '/assured-shorthold-tenancy-agreement-template',
    title: 'AST Legacy Guide',
    description: 'Older AST terminology explained with a route to the current England agreement example.',
    icon: 'document' as const,
    type: 'page' as const,
  },
