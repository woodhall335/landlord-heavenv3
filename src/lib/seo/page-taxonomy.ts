...
const LONGTAIL_LIVE_TAXONOMY: Record<string, SeoPageTaxonomyEntry> = {
  ...
  '/eviction-notice': makeEntry('/eviction-notice', {
    ...genericNoticeEntry('/eviction-notice', '/section-8-notice', {
    ...
    anchorVariants: {
      pillar: [
        ...
        'eviction notice route for landlords',
        'England eviction notice guide',
      ],
      supporting: [
        'Section 8 notice guide',
        'notice route before serving',
        'eviction notice template next steps',
      ],
      product: [...anchorSets.noticeOnlyProduct],
    },
  }),
  ...
  '/eviction-notice-england': makeEntry('/eviction-notice-england', {
    ...
    anchorVariants: {
      pillar: [
        'eviction notice template for England',
        'England possession notice guide',
...
export const SEO_PAGE_TAXONOMY: Record<string, SeoPageTaxonomyEntry> = {
  ...
  '/products/notice-only': makeEntry('/products/notice-only', {
    pageType: 'notice',
    pageRole: 'product-adjacent',
    jurisdiction: 'uk',
    cluster: 'notice-templates',
    ...
    anchorVariants: {
      ...
      supporting: [
        'transactional notice pack',
        'notice drafting service',
        'service steps before you serve',
      ],
      product: [...anchorSets.noticeOnlyProduct],
    },
    section21TransitionEligible: false,
  ...
  '/products/complete-pack': makeEntry('/products/complete-pack', {
    pageType: 'court',
    pageRole: 'pillar',
    jurisdiction: 'england',
    cluster: 'court-process',
    primaryPillar: SEO_PILLAR_ROUTES.completePack,
    ...
    canonicalTarget: SEO_PILLAR_ROUTES.completePack,
    anchorVariants: {
      pillar: [...anchorSets.completePackProduct],
      supporting: [
        'eviction court forms England',
        'court route after serving notice',
        'notice to court possession pack',
      ],
      product: [...anchorSets.completePackProduct],
    },
    section21TransitionEligible: false,
  ...
  '/products/money-claim': makeEntry('/products/money-claim', {
    pageType: 'money',
    pageRole: 'product-adjacent',
    jurisdiction: 'england',
    cluster: 'money-claim',
    ...
    anchorVariants: {
      pillar: [...anchorSets.moneyClaimPillar],
      supporting: [
        'start a landlord money claim pack',
        'money claim service for landlords',
  ...
  '/products/ast': makeEntry('/products/ast', {
    pageType: 'tenancy',
    pageRole: 'product-adjacent',
    jurisdiction: 'england',
    cluster: 'tenancy-england',
    primaryPillar: SEO_PILLAR_ROUTES.tenancyAgreementsEngland,
    supportingPage: '/tenancy-agreements/england',
    primaryProduct: SEO_PRODUCT_ROUTES.ast,
    primaryProductByScenario: {
      tenancy: SEO_PRODUCT_ROUTES.ast,
    },
    ...
    anchorVariants: {
      ...
      supporting: [
        ...
        'choose between England tenancy agreement types',
        'England tenancy agreement comparison',
      ],
      product: [...anchorSets.tenancyProduct],
    },
  ...
  '/tenancy-agreements': makeEntry('/tenancy-agreements', {
    ...
    primaryProduct: SEO_PRODUCT_ROUTES.ast,
    canonicalTarget: '/tenancy-agreement-template-uk',
    anchorVariants: {
      pillar: [...anchorSets.tenancyPillar],
  ...
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-1': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-1', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-1',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-1a': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-1a', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-1a',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-2': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-2', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-2',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-7a': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-7a', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-7a',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-8': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-8', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-8',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-10': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-10', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-10',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-11': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-11', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-11',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-12': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-12', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-12',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-13': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-13', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-13',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-14': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-14', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-14',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-15': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-15', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-15',
  }),
  '/section-8-grounds/how-to-evict-a-tenant-using-ground-17': section8Entry('/section-8-grounds/how-to-evict-a-tenant-using-ground-17', '/section-8-grounds-explained', {
    canonicalTarget: '/section-8-grounds/how-to-evict-a-tenant-using-ground-17',
  }),
