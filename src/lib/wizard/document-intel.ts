...
const FIELD_MAPPINGS: Array<{ keys: string[]; target: string }> = [
  ...
  { keys: ['rent_frequency', 'rent_period', 'payment_frequency'], target: 'rent_frequency' },
  { keys: ['deposit_amount', 'deposit'], target: 'deposit_amount' },
  { keys: ['deposit_scheme', 'deposit_provider', 'deposit_scheme_name'], target: 'deposit_scheme' },
  { keys: ['deposit_protected'], target: 'deposit_protected' },
  ...
  { keys: ['property_address', 'address', 'property_address_line1', 'address_line1'], target: 'property_address_line1' },
