...
describe('Wizard Landing Pages - Content Configuration', () => {
  ...
  describe('AST Premium Content', () => {
    ...
    it('should mention applicable legal basis per jurisdiction', () => {
      ...
      expect(englandCoverage?.legalBasis).toContain('ordinary residential premium agreement');
...
describe('Wizard Landing Pages - Pricing Accuracy', () => {
  it('should use correct price for Eviction Notice', () => {
    ...
    expect(noticeOnlyContent.price).toBe('£24.99');
  });
  ...
  it('should include price in title for all products', () => {
    expect(noticeOnlyContent.title).toContain('£24.99');
    expect(completePackContent.title).toContain('£59.99');
